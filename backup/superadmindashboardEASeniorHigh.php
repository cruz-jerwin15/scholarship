      ...
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-dark o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="superadmindashboard.php">
              <span class="float-left"><?php echo $row4['Category']?> </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="superadmindashboardEASeniorHigh.php">
              <span class="float-left"><?php echo $row1['Category']?> </span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
            </a>
         ...
         <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="superadmindashboardEACollege.php">
              <span class="float-left"><?php echo $row2['Category']?>  </span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
            </a>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="superadmindashboardEPSCollege.php">
              <span class="float-left"><?php echo $row3['Category']?> </span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
            </a>
...
WHERE canview = '0'&&approve = '1'&& category = 'EA Senior High'";
        ...
        <div class="modal-content">
         ...
         1. View statistics of approved applicant's by clicking the link at the left side "Dashboard"<br><br>
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="superadmindashboard.php">Back</a>
          </div>
        </div>
      </div>
    </div>
