...
&& d.id = (SELECT MAX(g2.id) FROM tbl_grades g2 WHERE d.user_id = g2.user_id )";
      ...
      if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
              ...
              echo "<tr>";
                ...
                echo "<td><a href='#' id='";
                echo $row['id'];
                echo "' onClick='getRemove(this.id)' data-toggle='modal' data-target='#removeStudent'> Remove </a></td>";
...
<script>
  ...
  function removeStudent(){
    window.open("remove.php?id="+ids,"_self");
  }
</script>
    <tfoot>
     <!--  <tr>
 ...
 <div class="modal fade" id="removeStudent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">Select "Yes" below if you are ready to remove this student.</div>
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
            <a class="btn btn-primary" href="#" onClick="removeStudent()">Yes</a>
          </div>
        </div>
      </div>
    </div>
