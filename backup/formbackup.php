...
<html lang="en">
 ...
 <?php
         if(isset($_POST["submit"])){
            ...
            $sql3 = "INSERT INTO tbl_useraddress (StreetNumber,RoadName,Barangay,Town,Province) 
            VALUES ('$Street','$RoadName','$Barangay','$Town','$Province')";

            $sql2 = "INSERT INTO tbl_school (YearCompleted,GWA,SchoolIntended,LastSchoolAttended,ExamRating,Course,Scholarship) 
            VALUES ('$HighestYearCompleted','$GWA','$SchoolIntended','$LastSchoolAttended','$ExamRating','$Courses','$Scholarship')";

            $sql4 = "INSERT INTO tbl_schooladdress (StreetNumber,RoadName,Barangay,Town,Province)
            VALUES ('$SchoolStreetNumber','$SchoolRoadName','$SchoolBarangay','$SchoolTown','$SchoolProvince')";

            $sql5 = "INSERT INTO tbl_parents (FatherFirstName,FatherMiddleName,FatherLastName,MotherFirstName,MotherMiddleName,MotherLastName,TotalMembers,siblings,Income)
            VALUES ('$FatherFirstName','$FatherMiddleName','$FatherLastName','$MotherFirstName','$MotherMiddleName','$MotherLastName','$NoFamilyMembers','$Siblings,'$Income')";

            $sql6 = "INSERT INTO tbl_parentsaddress (StreetNumber,RoadName,Barangay,Town,Province)
            VALUES ('$ParentStreetNumber','$ParentRoadName','$ParentBarangay','$ParentTown','$ParentProvince)";

            $sql7 = "INSERT INTO tbl_siblings (FirstName,MiddleName,LastName,sib_educ_assist,sib_course,sib_year)
            VALUES ('$SiblingFirstName','$SiblingMiddleName','$SiblingLastName','$sib_educ_assist','$Course','$Year')";
