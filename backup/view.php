      ...
      <section id="header">
        ...
        <nav class="navbar navbar-light" data-spy="affix" data-offset-top="50">
          <div class="container">
            ...
            <!-- Brand -->
            <a class="navbar-brand" href="superadminhomepage.php">
            ...
            <ul class="nav nav-inline">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link" href="superadminhomepage.php" role="button" aria-haspopup="true" aria-expanded="false"> Go Back </a>                  
                </li>                                     
