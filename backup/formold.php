...
<script type="text/javascript">
  function getAge(){
    ...
    <style>
        body {
      background: url('img/mhfade.jpg')  no-repeat center center fixed;
 ...
 <?php
         if(isset($_POST["submit"])){
            ...
            $sql = "INSERT INTO tbl_userinfo (FirstName,MiddleName,LastName,Age,Sex,DateOfBirth,PlaceOfBirth,Citizenship,Image,EmailAddress, fb_account) 
            VALUES ('$fname','$mname','$lname','$age','$sex','$bday','$PlaceOfBirth','$Citizenship', '$Image','$EmailAddress', '$fb')";
            ...
            $sql2 = "INSERT INTO tbl_school (user_id,YearCompleted,GWA,SchoolIntended,LastSchoolAttended,ExamRating,Course,Scholarship) 
            ...
            $sql5 = "INSERT INTO tbl_parents (user_id,FatherFirstName,FatherMiddleName,FatherLastName,MotherFirstName,MotherMiddleName,MotherLastName,TotalMembers,siblings,Income)
            VALUES ('$last_id', '$FatherFirstName','$FatherMiddleName','$FatherLastName','$MotherFirstName','$MotherMiddleName','$MotherLastName','$NoFamilyMembers','$Siblings','$Income')";
            ...
            $sql_result = $result_user && $result_useraddress && $result_school && $result_schooladdress && $result_parents  && $result_parentsaddress && $result_siblings ;
            if($sql_result){
         ...
         <!--  <div class="card"  style="width:250px;height:250px;"> -->
          ...
          <div class="row">
            ...
            <div class="col-lg-4"> 
              ...
              <div class="form-group">
                <input type="date" name="birthdate" id="birthdate" class="form-control input-lg " onblur="getAge();">
              </div>
            ...
            <div class="col-lg-4"> 
              ...
              <div class="form-group">
                <input type="number"  id ="Age" name="Age" class="form-control input-lg" placeholder="Age"
                readonly="readonly" >
              </div>
