...
?>
      ...
      <div class="row">
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-dark o-hidden h-100">
            ...
            <p class="card-footer text-white clearfix small z-1" >
              <span class="float-left"> <h3 style="font-size: 150%;padding-left: 10px;"> <?php echo $row4['Category']?></h3></span>
        ...
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            ...
            <p class="card-footer text-white clearfix small z-1">
              <span class="float-left"><h3 style="font-size: 150%;padding-left: 10px;"> <?php echo $row1['Category']?>  </h3></span>
            </p>
          </div>
        </div>
         ...
         <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            ...
            <p class="card-footer text-white clearfix small z-1">
              <span class="float-left"> <h3 style="font-size: 150%;padding-left: 10px;">  <?php echo $row2['Category']?>  </h3></span>
            </p>
          </div>
        </div>
        ...
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            ...
            <p class="card-footer text-white clearfix small z-1">
              <span class="float-left"> <h3 style="font-size: 150%;padding-left: 10px;">  <?php echo $row3['Category']?>  </h3></span>
            </p>
          </div>
        </div>
    </div>
  ...
  a.id,
    ...
    c.assessment_grade,
    a.remarks,
    c.GWA_now, c.SchoolYear, a.Category
