      ...
      <div class="row">
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-dark o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="superadminapprove.php">
        ...
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="superadminapproveEASHS.php">
         ...
         <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="superadminapproveEACollege.php">
        ...
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="superadminapproveEPSCollege.php">
...
WHERE canview = '0' and approve = '0' and Category = 'EA Senior High'&& d.id = (SELECT MAX(g2.id) FROM tbl_grades g2 WHERE d.user_id = g2.user_id )";
      ...
      if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
              echo "<tr>";
                ...
                echo "<td><a href='viewrequirements.php?id=".$row['id']."'>View Requirements</a></td>";
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="superadminapprove.php">Back</a>
          </div>
        </div>
      </div>
    </div>
