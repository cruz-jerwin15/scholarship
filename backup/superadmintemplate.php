      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="superadminhomepage.php">
            ...
            <span class="nav-link-text">Super Admin Home</span>
          </a>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Levels">
          ...
          <a class="nav-link" href="manageapplicant.php">
            ...
            <span class="nav-link-text"> Manage Removed Applicants </span>
               ...
               <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="superadmintemplate.php">
            <i class="fa fa-fw fa-user"></i>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Add Another Admin</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="superadminaddadmin.php">
