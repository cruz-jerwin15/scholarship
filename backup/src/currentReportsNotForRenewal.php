...
$pdf->SetTitle($title);
    ...
    $pdf->Cell(0,17,'',0,1);
     ...
     $stats="Not NOT FOR RENEWAL";
     if($filter=="ALL"){
                      if($_SESSION['whatsearch']=="ALL"){
                        $pdf->Cell(190,$header_height,"NOT FOR RENEWAL",0,0,'C');
                        $pdf->Cell(190,10,'',0,1);
                          if($filterss=="LastName"){
                            ...
                            $types="fullscholar";
                               $sql = "SELECT tbl_admin.username,tbl_admin.batch,tbl_admin.academic_year,tbl_admin.application_no,tbl_studentinfo.firstname,tbl_studentinfo.middlename,tbl_studentinfo.lastname,tbl_studentinfo.barangay,tbl_studentinfo.course,tbl_studentinfo.gradelevel,tbl_admin.typescholar,tbl_studentinfo.school,tbl_renewal.academic_id,tbl_grade_submit.grades
                              FROM tbl_admin
                              INNER JOIN tbl_studentinfo
                              ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                              JOIN tbl_renewal
                              ...
                              JOIN tbl_grade_submit
                               ON tbl_admin.academic_year=tbl_grade_submit.academic_year AND tbl_admin.application_no=tbl_grade_submit.application_no
                               WHERE tbl_admin.typescholar='$types' AND tbl_renewal.status='$stats'
                    ...
                    $sem = $_SESSION['whatsearch'];
                     ...
                     $sqlz="SELECT * from tbl_renew_year WHERE semester='$sem'";
                              ...
                              JOIN tbl_renewal
                              ON tbl_admin.academic_year=tbl_renewal.academic_year AND tbl_admin.application_no=tbl_renewal.application_no
                              WHERE tbl_renewal.academic_id='$acad'  AND tbl_renewal.status='$stats'
                              ORDER BY tbl_studentinfo.lastname";
                            ...
                            $types="fullscholar";
                              ...
                              JOIN tbl_grade_submit
                               ON tbl_admin.academic_year=tbl_grade_submit.academic_year AND tbl_admin.application_no=tbl_grade_submit.application_no
                               WHERE tbl_admin.typescholar='$types' AND tbl_renewal.academic_id='$acad' AND tbl_renewal.status='$stats'
                                ORDER BY tbl_admin.batch";
                ...
                if($filter=="FULL SCHOLARSHIP"){
                  ...
                  if($_SESSION['whatsearch']=="ALL"){
                      ...
                      if($filterss=="LastName"){
                              $sql = "SELECT tbl_admin.username,tbl_admin.academic_year,tbl_admin.application_no,tbl_studentinfo.firstname,tbl_studentinfo.middlename,tbl_studentinfo.lastname,tbl_studentinfo.barangay,tbl_studentinfo.course,tbl_studentinfo.gradelevel,tbl_admin.typescholar,tbl_studentinfo.school,tbl_renewal.academic_id,tbl_admin.batch
                              FROM tbl_admin
                              INNER JOIN tbl_studentinfo
                              ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                              JOIN tbl_renewal
                              ON tbl_admin.academic_year=tbl_renewal.academic_year AND tbl_admin.application_no=tbl_renewal.application_no
                              WHERE tbl_admin.typescholar='$scholarship'  AND tbl_renewal.status='$stats'
                                ORDER BY tbl_studentinfo.lastname";
                              ...
                              while($row = $result->fetch_assoc()){
                               ...
                               $sql = "SELECT tbl_admin.username,tbl_admin.academic_year,tbl_admin.application_no,tbl_studentinfo.firstname,tbl_studentinfo.middlename,tbl_studentinfo.lastname,tbl_studentinfo.barangay,tbl_studentinfo.course,tbl_studentinfo.gradelevel,tbl_admin.typescholar,tbl_studentinfo.school,tbl_renewal.academic_id,tbl_admin.batch,tbl_grade_submit.grades
                              FROM tbl_admin
                              INNER JOIN tbl_studentinfo
                              ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                              JOIN tbl_renewal
                    ...
                    $sem = $_SESSION['whatsearch'];
                      $sqlz="SELECT * from tbl_renew_year WHERE semester='$sem'";
                            ...
                            if($filterss=="LastName"){
                              ...
                              JOIN tbl_renewal
                              ON tbl_admin.academic_year=tbl_renewal.academic_year AND tbl_admin.application_no=tbl_renewal.application_no
                              WHERE tbl_admin.typescholar='$scholarship' AND tbl_renewal.academic_id='$acad' AND tbl_renewal.status='$stats'
                                ORDER BY tbl_studentinfo.lastname";
...
$pdf->SetFont('Times','',13);
  ...
  $pdf->Cell(0,7,'',0,1);
  $pdf->Cell(190,10,"Youth Development Officer (CYDSD)",0 ,0,'L');

  $pdf->Cell(0,15,'',0,1);
  $pdf->Cell(190,10,"Recommending Approval:",0 ,0,'L');
  $pdf->Cell(0,13,'',0,1);
  $pdf->Cell(190,10,"ENGR. SEVERINO M. MEDALLA",0,0,'L');
  $pdf->Cell(0,7,'',0,1);
  $pdf->Cell(190,10,"City Administrator",0 ,0,'L');


  $pdf->Cell(0,15,'',0,1);
  $pdf->Cell(190,10,"Approved by:",0 ,0,'L');
  $pdf->Cell(0,13,'',0,1);
  $pdf->Cell(190,10,"ATTY. ARTH JHUN AGUILAR MARASIGAN",0,0,'L');
  $pdf->Cell(0,7,'',0,1);
  $pdf->Cell(190,10,"Public Servant/City Mayor",0 ,0,'L');
