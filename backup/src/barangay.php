          ...
          <div class="content-wrapper">
            ...
            <div class="row">
             <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">List of Barangays</h4>
                        ...
                        <?php
                          ...
                          if ($result->num_rows > 0){
                              while($row = $result->fetch_assoc()){
                                ...
                                echo '<button id="';
                                echo $row['id'];
                                echo '" type="button" class="btn btn-icons btn-rounded btn-danger" onClick="getRemoveId(this.id)" data-toggle="modal" data-target="#addUser">
