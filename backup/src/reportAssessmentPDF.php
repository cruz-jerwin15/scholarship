...
$whatsearch=$_SESSION['whatsearch'];
    ...
    $userid=$rowab['user_id'];
      $totalscore=0;
        $sql = "SELECT * FROM tbl_admin WHERE id='$userid' ORDER BY applicant_number";
   ...
   $pdf->Cell(70,$content_height,$name_school_sh,1,0,'L');
    ...
    if( $school_type_college_points<=0){
         $pdf->Cell(65,$content_height,"College",1,0,'L');
         $pdf->Cell(70,$content_height,"",1,0,'L');

        $pdf->Cell(30,$content_height,"",1,0,'L');
        $pdf->Cell(25,$content_height,"",1,0,'C');
