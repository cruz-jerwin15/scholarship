...
if(($_SESSION['studenttype']!="collegerecipient")||($_SESSION['pages']!="new-collegerecipient")){
 $_SESSION['studenttype']="collegerecipient";
  $_SESSION['search']="ALL";
  $_SESSION['pages']="new-collegerecipient";
  $_SESSION['whatsearch']="";
  $_SESSION['order']="ASC";
  $_SESSION['limit']=10;
  $_SESSION['offset']=1;
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">New Applicant >College Educational Assistance (<?php echo $category;?>)</h4>
            ...
            <div class="row">
              <!-- Tabe here -->
               <?php
                ...
                if($filter=="ALL"){
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.school,tbl_studentinfo.course,tbl_studentinfo.schooltype
                        FROM tbl_admin
                     ...
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.school,tbl_studentinfo.course
                        FROM tbl_admin
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                  ...
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.school,tbl_studentinfo.course
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.username='$whatsearch' ORDER BY tbl_admin.username ASC LIMIT ".$limit." OFFSET ".$off;
                        ;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.username='$whatsearch'";
                     ...
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.school,tbl_studentinfo.course
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.username='$whatsearch' ORDER BY tbl_admin.username DESC LIMIT ".$limit." OFFSET ".$off;
                        ;
                  ...
                  $schooltypes="Private / Institute";
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.school,tbl_studentinfo.course
                        FROM tbl_admin
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$schooltypes' ORDER BY tbl_studentinfo.lastname ASC LIMIT ".$limit." OFFSET ".$off;
                        ;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                         WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$schooltypes'";
                     ...
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.school,tbl_studentinfo.course
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$schooltypes' ORDER BY tbl_studentinfo.lastname DESC LIMIT ".$limit." OFFSET ".$off;
                        ;
                  ...
                  $schooltypes="Public / State Universities";
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.school,tbl_studentinfo.course
                        FROM tbl_admin
                        INNER JOIN tbl_studentinfo
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                          <h4 class="card-title"> List of College Recipient Applicants </h4>
                      </div>
                      <?php
...
if($filter=="ALL"){
  ...
  $rowb = $resultb->fetch_assoc();
    $users=isset($rowb['user_id']);
    $sqld = "SELECT * FROM tbl_college_requirements_label WHERE user_id='$userids'";
    $resultd = $conn->query($sqld);
...
echo '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update Requirements';
        // echo $row['id'];
      //  echo ;
        echo '</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
echo '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  if($order=="ASC"){
       ...
       $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no
        ...
        INNER JOIN tbl_studentinfo
        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype= '$typeschool' ORDER BY tbl_studentinfo.lastname ASC LIMIT ".$limit." OFFSET ".$off;
     ...
     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no
        ...
        INNER JOIN tbl_studentinfo
        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype= '$typeschool' ORDER BY tbl_studentinfo.lastname DESC LIMIT ".$limit." OFFSET ".$off;
  }
  $result = $conn->query($sql);
  while($row = $result->fetch_assoc()){
      $userids=$row['id'];
          ...
          <div class="col-md-12">
              <div class="form-group">';
                if($rowb['yourvotersid']==0){
                  ...
                  echo ' <label ><span class="badge badge-primary"><i class="fas fa-share"></i></span>&nbsp Voters ID or Voters Certification of applicant (for 18 years old and above)';
                      echo '<span> Not Applicable</span></label>
                  <select name="yourvotersid" class="form-control">
                    <option value="0">Disapproved</option>
                    <option value="2">Submitted</option>
                    ...
                    echo ' <label ><span class="badge badge-success"><i class="fa fa-check"></i></span>&nbsp Voters ID or Voters Certification of applicant (for 18 years old and above) &nbsp; <a target="_blank" href="requirements/';
                   echo $yourvotersid_label;
                   echo '">View</a></label>';
