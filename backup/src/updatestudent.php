...
$result = $conn->query($sql);
  ...
  $count4=1;
    ...
    if($stats=="PREAPPLICATION"){
       echo '<script language="javascript">';
    // echo 'localStorage.setItem("notif","0")';
      echo 'window.open("updatesstudent.php","_self")';
      echo '</script>';
    }
  ...
  <body onload="initLoad()">
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
                   ...
                   <h4 class="page-title">
                    <?php
                      if($_SESSION['studenttype']=="fullscholar"){
                          if(($stats=="NEWAPPLICANT")||($stats=="PREAAPLICATION")||($stats=="ASSESSMENT")||($stats=="INTERVIEW")){
                             echo "College Full Scholar Applicant Information";
                          }else{
                             echo "College Full Scholars Information";
                          }

                      }else  if($_SESSION['studenttype']=="collegerecipient"){
                         if(($stats=="NEWAPPLICANT")||($stats=="PREAAPLICATION")||($stats=="ASSESSMENT")||($stats=="INTERVIEW")){
                              echo "College Educational Assistance Applicant Information";
                          }else{
                             echo "College Recipients Information";
                          }

                      }else  if($_SESSION['studenttype']=="shscholar"){
                        if(($stats=="NEWAPPLICANT")||($stats=="PREAAPLICATION")||($stats=="ASSESSMENT")||($stats=="INTERVIEW")){
                              echo "SHS Educational Assistance Applicant Information";
                          }else{
                             echo "SHS Recipients Information";
                          }
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                   ...
                   <h4>Welcome to Youth Development Office. Please update your information by clicking button below</h4>
                   </div>
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-12">
                    <a href="next_app.php" style="width:100%;heigth:100px;font-size:2em;" class="btn btn-success">Click me to add your personal information</a>
                    </div>
                    </div>
                      </div>';
                      }else if(($stats=="NEWAPPLICANT")||($stats=="INTERVIEW")||($stats=="ASSESSMENT")){
                         echo '<div class="col-md-12">
                       <h4>Welcome to Youth Development Office. We currently processing your application. Make sure you already uploaded your requirements.</h4>
                       </div>';
                      }else{
                        echo '<div class="col-md-12">
                       <h4>Welcome to Youth Development Office.</h4>
                       </div>';
                       echo '<div class="col-md-12">
                    <div class="row">
                      <div class="col-md-12">
                    <a href="next_app.php" style="width:100%;heigth:100px;font-size:2em;" class="btn btn-success">Click me to update your personal information</a>
                    </div>
                    </div>';
                      }
                    ...
                    ?>
                        ...
                        <form action="registerProfilePicture.php" method="post" enctype="multipart/form-data">
        ...
        <form class="form-horizontal" action="registerInformation.php" method="post">
              <div class="col-md-12">
                  <div class="row">
                   <div class="col-md-12">
                    <div class="form-group">
              ...
              echo ' <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label >Year Level<span style="color:red;">*</span></label>
                        <select name="years" class="form-control">';
                          if(($_SESSION['student']=="RENEW")||($_SESSION['student']=="OK")||($_SESSION['student']=="ASSESS")){
                            if($years=="1ST"){
                              echo '<option value="1ST" selected="selected">1ST</option>';
                              echo '<option value="2ND">2ND</option>';
                               echo '<option value="3RD">3RD</option>';
       ...
       //              if($_SESSION['studenttype']=="shscholar"){
             // if(($_SESSION['student']=="RENEW")||($_SESSION['student']=="OK")||($_SESSION['student']=="ASSESS")||($_SESSION['student']=="NEWAPPLICANT")||($_SESSION['student']=="INTERVIEW")||($_SESSION['student']=="ASSESSMENT")){
            //  echo ' <div class="col-md-12">
       //                  <div class="form-group">
       //                    <label >Track Intended to Take<span style="color:red;">*</span></label>
       //                      <input type="text" name="course" class="form-control" placeholder="Track" required="true"
       ...
       //                      if(($years=="1ST")||($years=="1st")||($years=="1ST Year")||($years=="1st Year")||($years=="1ST YEAR")||($years=="1st YEAR")){
       //                        echo '<option value="1ST" selected="selected">1st</option>';
       //                      }else{
       //                        echo '<option value="1ST">1st</option>';
       //                      }
       //                      if(($years=="2ND")||($years=="2nd")||($years=="2ND Year")||($years=="2nd Year")||($years=="2ND YEAR")||($years=="2nd YEAR")){
       //                        echo '<option value="2ND" selected="selected">2nd</option>';
       //                      }else{
       //                        echo '<option value="2ND">2nd</option>';
       //                      }
       //                      if(($years=="3RD")||($years=="3rd")||($years=="3RD Year")||($years=="3rd Year")||($years=="3RD YEAR")||($years=="3rd YEAR")){
       //                        echo '<option value="3RD" selected="selected">3rd</option>';
       //                      }else{
       //                        echo '<option value="3RD">3rd</option>';
       //                      }
       //                       if(($years=="4TH")||($years=="4th")||($years=="4TH Year")||($years=="4th Year")||($years=="4TH YEAR")||($years=="4th YEAR")){
       //                        echo '<option value="4TH" selected="selected">4th</option>';
       //                      }else{
       //                        echo '<option value="4TH">4th</option>';
       //                      }
       //                      if(($years=="5TH")||($years=="5th")||($years=="5TH Year")||($years=="5th Year")||($years=="5TH YEAR")||($years=="5th YEAR")){
       //                        echo '<option value="5TH" selected="selected">5th</option>';
       //                      }else{
       //                        echo '<option value="5TH">5th</option>';
       //                      }
       ...
       //              }
                    ...
                    if($_SESSION['studenttype']=="fullscholar"){
                      ...
                      <div class="form-group">
                        <label >School<span style="color:red;">*</span></label>
                         ...
                         if($school=="La Consolacion College Tanauan"){
                            echo '<option value="La Consolacion College Tanauan" selected="selected">La Consolacion College Tanauan</option>';
                         }else{
                            echo '<option value="La Consolacion College Tanauan">La Consolacion College Tanauan</option>';
                         }
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <form method="POST" action="registereducationalbackground.php">
                       <div class="col-md-12">
                          <div class="row">
                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                      <div class="form-group">
                                        ...
                                        <?php
                                           if(($_SESSION['studenttype']=="fullscholar")||($_SESSION['studenttype']=="shscholar")||($_SESSION['studenttype']=="collegerecipient")){
                    ...
                    if($years=="GRADE 12"){
                        echo '<div class="col-md-12">
                                      <div class="form-group">
                                        <label style="font-weight:600;">Senior High School *(If applying for Grade 11, leave this blank)</label>
                                      </div>
                                    </div>';
                                    echo ' <div class="col-md-12">
                                      <div class="form-group">
                  ...
                  <!-- End Personal Information -->
                    ...
                    <!-- <p class="card-description"> Add class <code>.table</code> </p> -->
                              ...
                              <tbody>
                                <?php
                                    ...
                                    if ($resulta->num_rows > 0){
                                      ...
                                      echo $rowa['id'];
                                      echo '">
                                        <i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Click to update sibling information!"></i>';
                                         echo '</button>&nbsp';
                                         echo '<button class="btn btn-icons btn-rounded btn-danger" data-toggle="modal" data-target="#removeModal';
                                         echo $rowa['id'];
                                         echo '" ><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="Click to remove sibling!"></i></button>';
                                        echo '</center></td>';
                                        echo '</tr>';
                                        $count = $count+1;
                                      }
                      ...
                      <!-- <p class="card-description"> Add class <code>.table</code> </p> -->
                            ...
                            <form  action="studentadditionalInformation.php" method="post">
                            <div class="col-md-12">
                                  <div class="row">
                                        ...
                                        if($informed==$rowa['legend']){
                                          ...
                                          echo '</option>';
                                            ...
                                            <div class="col-md-12">
                                              ...
                                              <div class="col-md-12">
                                               <div class="form-group">
                                                <label>Student PWD<span style="color:red;">*</span></label>
                                                 <select name="student_pwd" class="form-control">
                                                 <?php
                                                    if($student_pwd=="YES"){
                                                      echo '<option value="YES" selected="YES">YES</option>';
                                                    }else{
