...
if (($_SESSION['studenttype'] != "fullscholar") || ($_SESSION['pages'] != "removeapplicant-fullscholar")) {



  $_SESSION['studenttype'] = "fullscholar";
  $_SESSION['search'] = "ALL";
  $_SESSION['pages'] = "removeapplicant-fullscholar";
  $_SESSION['whatsearch'] = "";
  $_SESSION['order'] = "ASC";
  $_SESSION['limit'] = 10;
  $_SESSION['offset'] = 1;
      ...
      <div class="main-panel">
          ...
          <div class="row page-title-header">
            <div class="col-12">
              <div class="page-header">
                <h4 class="page-title">Removed Applicant > College Full Scholarship </h4>
        ...
        <div class="row">
          ...
          if ($filter == "ALL") {
            ...
            if ($order == "ASC") {
              $sql = "SELECT tbl_admin.id as user_id,tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.phone,tbl_studentinfo.barangay,tbl_remarks.remarks
                  FROM tbl_admin
          ...
          <div class="col-md-12 grid-margin">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <h4 class="card-title"> List of Removed College Full Scholarship Applicants</h4>
                  <table class="table">
                    <thead>
                      <tr>
                        <th style="width:5%;">#</th>
