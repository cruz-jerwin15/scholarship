            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                   <h4 class="page-title">New Senior High Applicant Information</h4>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                             <div class="row">
                                <form action="updateNewSHSprofile.php" method="post" enctype="multipart/form-data">
                               <div class="col-md-6">
                      ...
                      <div class="col-md-8">
                       <div class="row">
                          <div class="col-md-4">
                             <form action="updateNewSHSInfo.php" method="POST">
                      ...
                      <div class="col-md-12">
                        <hr>
                          ...
                          <div class="col-md-12">
                           <div class="form-group">
                            <form action="updateNewSHSFamilyInfo.php" method="POST">
                               <input type="hidden" name="userid" value="<?php echo $userid;?>">
                      ...
                      <div class="col-md-12">
                         <div class="form-group">
                          <form action="updateNewSHSEducational.php" method="POST">
                               <input type="hidden" name="userid" value="<?php echo $userid;?>">
...
echo '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="updateSiblingsNewSHS.php" method="post">
...
echo '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     <form action="removeSiblingsNewSHS.php" method="post">
      <div class="modal-header">
...
<div class="modal fade" id="addSiblings" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <!-- Start of form -->
      <form action="addSiblingsSHS.php" method="POST">
      <div class="modal-body">
        <div class="row">
