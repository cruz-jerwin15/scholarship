        ...
        <div class="main-panel">
          <div class="content-wrapper">
                               ...
                               <div class="col-md-9">
                                <div class="row">
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    echo $row['id'];
                                    echo '" onClick="addQuestion(this.id)"><i class="fa fa-plus"></i></button>

                                    <button class="btn btn-warning" id="';
                                    echo $row['id'];
                                    echo '" onClick="viewQuestion(this.id)"><i class="fa fa-eye"></i></button>
                                  </div>
                      ...
                      <div class="col-md-12 grid-margin">
                        <div class="card">
                          <div class="card-body">
                             <div class="row">
                                 <div class="col-md-12">
                                  <form method="POST" action="saveSection.php">
                                    <div class="row">
                                      <div class="col-md-12">
                                       ...
                                       <div class="col-xs-12 col-md-6">
                                           <div class="form-group row">
                                            ...
                                            <input type="text" class="form-control" name="section_title" id="section_title" placeholder="Type title of section here." required>
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-xs-12 col-md-2">
                                        <div class="form-group row">
                                            ...
                                            <input type="color" class="form-control" name="section_color" id="section_color" required>
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-xs-12 col-md-12">
                                       ...
                                       <div class="col-xs-12 col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <input type="number" class="form-control" name="timer" id="timer" placeholder="Type time here in minutes" required>
                                          </div>
                                       </div>
           ...
           ?> 
            ...
            <?php
            if($_SESSION['section']=="EDIT"){
              $id=$_SESSION['section_id'];
              $sql1 = "SELECT * FROM tbl_section WHERE id='$id'";
              $result1 = $conn->query($sql1);
              $row1 = $result1->fetch_assoc();
                echo '<div class="row">
                      <div class="col-md-12 grid-margin">
                        <div class="card">
                          <div class="card-body">
                             <div class="row">
                                 <div class="col-md-12">
                                  <form method="POST" action="saveUpdateSection.php">
                                    <div class="row">
                                      <div class="col-md-12">
                                       ...
                                       <div class="col-xs-12 col-md-6">
                                           <div class="form-group row">
                                            <label>Section Title</label>
                                            <input type="text" class="form-control" name="section_title" id="section_title" value="';
                                            echo $row1['title'];
                                            echo '" placeholder="Type title of section here." required>
                                          </div>
                                      </div>
                                        <div class="col-xs-12 col-md-1">
                                      </div>
                                      <div class="col-xs-12 col-md-2">
                                        <div class="form-group row">
                                            ...
                                            <input type="color" value="';
                                             echo $row1['colors'];
                                            echo '" class="form-control" name="section_color" id="section_color" required>
                                          </div>
                                      </div>
                                      <div class="col-xs-12 col-md-3">
                                      </div>
                                       ...
                                       <div class="col-xs-12 col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <input type="number" value="';
                                             echo $row1['timer'];
                                            echo '" class="form-control" name="timer" id="timer" placeholder="Type time here in minutes" required>
                                          </div>
                                       </div>
           ...
           ?> 
            <?php
          if($_SESSION['section']=="ADDQUESTION"){
            $id=$_SESSION['section_id'];
             ...
             echo '<div class="row">
               <div class="col-md-12 grid-margin">
                <div class="card">
                  ...
                  $sectionids = $_SESSION['section_id'];
                      if($_SESSION['filterquest']=="ALL"){
                         ...
                         $sql1 = "SELECT COUNT(*) as total FROM  tbl_questbank WHERE status='OPEN'";
                          ...
                          $sql = "SELECT * FROM  tbl_questbank WHERE status='OPEN'  AND quest_type='$typequest' ORDER BY id DESC  LIMIT 10 OFFSET ".$offset;
                           $sql1 = "SELECT COUNT(*) as total FROM  tbl_questbank WHERE status='OPEN' AND quest_type='$typequest'";
                      }else if($_SESSION['filterquest']=="IMAGE/TEXT"){
                          $sql = "SELECT * FROM  tbl_questbank WHERE status='OPEN'  AND quest_type='$typequest' ORDER BY id DESC  LIMIT 10 OFFSET ".$offset;
                           $sql1 = "SELECT COUNT(*) as total FROM  tbl_questbank WHERE status='OPEN' AND quest_type='$typequest'";
                      }
                          ...
                          while($row = $result->fetch_assoc()){
                            ...
                            $quest_id=$row['id'];
                            $sql2 = "SELECT * FROM  tbl_section_quest WHERE section_id='$sectionids' AND quest_id='$quest_id'";
                            $result2 = $conn->query($sql2);
                           
                            $num++;
                            echo '<form action="addMultipleQuestion.php" method="POST"  enctype="multipart/form-data">';
                            if($row['quest_type']=="TEXT"){
                                if ($result2->num_rows > 0){
                                   echo '<div class="col-md-12" style="margin-top:1em;background-color:#91d5ff;">
                                  <div class="row">
                                      <div class="col-md-8">
                    ...
                    echo '<div class="col-md-12" style="margin-top:1em;text-align:right;">';
                    echo '<input type="submit" class="btn btn-primary" value="Add to Section">';
                    echo '</div>';
                  echo '</form>';
                
                  
                  echo '<div class="col-md-3" style="margin-top:2em;">';
                   
                        if($offset<=1){
                          echo '<button class="btn btn-warning" disabled>Previous</button>';
                        }else{
                           echo '<a href="back_questsection.php" class="btn btn-warning" >Previous</a>';
                        }
                      ...
                      echo ($offset+1)."-".$num.'/'.$total;
                        ...
                        if($num>=$total){
                          echo '<button class="btn btn-primary" disabled>Next</button>';
                           ...
                           echo '<a href="next_questsection.php" class="btn btn-primary">Next</a>';
                        }
