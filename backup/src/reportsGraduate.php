...
if(($_SESSION['studenttype']!="collegerecipient")||($_SESSION['pages']!="graduatereport-collegerecipient")){

 
    
         $_SESSION['studenttype']="collegerecipient";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="graduatereport-collegerecipient";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Reports > Graduates </h4>
             ...
             <!--  <div class="col-md-8 ">
              ...
              <div class="col-md-12"><hr></div>
               <form  action="getGraduateReport.php" method="post">
              <div class="col-md-12">
                <!-- <div class="page-header-toolbar"> -->
                  <div class="row">
                    <div class="col-md-3">
            ...
            <div class="row">
              <!-- Tabe here -->
               <?php
                ...
                if($filter=="ALL"){
                  if($order=="ASC"){
                    $sql ="SELECT * FROM tbl_remarks WHERE process='$remove' ORDER BY user_id ASC LIMIT ".$limit." OFFSET ".$off;

                    $sql1 ="SELECT COUNT(user_id) as total FROM tbl_remarks WHERE process='$remove'"; 
                  }else{
                       $sql ="SELECT * FROM tbl_remarks WHERE process='$remove' ORDER BY user_id DESC LIMIT ".$limit." OFFSET ".$off;

                    $sql1 ="SELECT COUNT(user_id) as total FROM tbl_remarks WHERE process='$remove'";  
                  }
              }else if($filter=="ACADEMIC YEAR"){
                  if($order=="ASC"){
                     $sql = "SELECT DISTINCT(tbl_remarks.user_id)
                        FROM tbl_remarks 
                        INNER JOIN tbl_academic 
                        ON tbl_academic.id=tbl_remarks.academic_id
                        WHERE tbl_academic.academic_year LIKE '$whatsearch%' AND tbl_remarks.process='$remove' ORDER BY tbl_remarks.user_id ASC LIMIT ".$limit." OFFSET ".$off;
                   
                   $sql1 = "SELECT COUNT(DISTINCT(tbl_remarks.user_id)) as total
                        FROM tbl_remarks 
                        INNER JOIN tbl_academic 
                        ON tbl_academic.id=tbl_remarks.academic_id
                        WHERE tbl_academic.academic_year LIKE '$whatsearch%' AND tbl_remarks.process='$remove'";
                  }else{
                     $sql = "SELECT DISTINCT(tbl_remarks.user_id)
                        FROM tbl_remarks 
                        INNER JOIN tbl_academic 
                        ON tbl_academic.id=tbl_remarks.academic_id
                        WHERE tbl_academic.academic_year LIKE '$whatsearch%' AND tbl_remarks.process='$remove' ORDER BY tbl_remarks.user_id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                     $sql = "SELECT DISTINCT(tbl_remarks.user_id)
                        ...
                        INNER JOIN tbl_academic 
                        ON tbl_academic.id=tbl_remarks.academic_id
                        WHERE tbl_academic.academic_year LIKE '$whatsearch%' AND tbl_remarks.scholars='$scholarship' AND tbl_remarks.process='$remove' ORDER BY tbl_remarks.user_id ASC LIMIT ".$limit." OFFSET ".$off;
                   
                   $sql1 = "SELECT COUNT(DISTINCT(tbl_remarks.user_id)) as total
                        FROM tbl_remarks 
                        INNER JOIN tbl_academic 
                        ON tbl_academic.id=tbl_remarks.academic_id
                        WHERE tbl_academic.academic_year LIKE '$whatsearch%' AND tbl_remarks.scholars='$scholarship' AND tbl_remarks.process='$remove'";
                  }else{
                     $sql = "SELECT DISTINCT(tbl_remarks.user_id)
                        FROM tbl_remarks 
                        INNER JOIN tbl_academic 
                        ON tbl_academic.id=tbl_remarks.academic_id
                        WHERE tbl_academic.academic_year LIKE '$whatsearch%' AND tbl_remarks.scholars='$scholarship' AND tbl_remarks.process='$remove' ORDER BY tbl_remarks.user_id DESC LIMIT ".$limit." OFFSET ".$off;
                      ...
                      <?php
                        if($_SESSION['page']<=1){
                          echo '<button class="btn btn-warning" disabled>Previous</button>';
                           ...
                           echo '<a href="graduates_back.php" class="btn btn-warning" >Previous</a>';
                        }
                      ?>
                       <?php echo ($off+1)."-".$count.'/'.$total?>
                        ...
                        if($count>=$total){
                          echo '<button class="btn btn-primary" disabled>Next</button>';
                           ...
                           echo '<a href="graduates_next.php" class="btn btn-primary">Next</a>';
                        }
                      ?>
