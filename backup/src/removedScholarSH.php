...
if(($_SESSION['studenttype']!="shscholar")||($_SESSION['pages']!="removescholars-shscholar")){

 
    
          $_SESSION['studenttype']="shscholar";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="removescholars-shscholar";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Removed Recipients > SHS Educational Assistance </h4>
             ...
             <!--  <div class="col-md-8 ">
              ...
              <div class="col-md-12"><hr></div>
               <form  action="getRemoveScholarSearch.php" method="post">
              <div class="col-md-12">
                <!-- <div class="page-header-toolbar"> -->
                  <div class="row">
                    <div class="col-md-3">
            ...
            <div class="row">
                ...
                if($filter=="ALL"){
                 if($order=="ASC"){
                      ...
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        WHERE (((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total 
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id   
                          WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id'";
                     ...
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id 
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id 
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' AND tbl_admin.username='$whatsearch' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total 
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id   
                          WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' AND tbl_admin.username='$whatsearch'";
                      ...
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id 
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' AND tbl_admin.username='$whatsearch' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id 
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' AND tbl_studentinfo.lastname LIKE '$whatsearch%' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total 
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id   
                          WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' AND tbl_studentinfo.lastname LIKE '$whatsearch%'";
                       ...
                       $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id 
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' AND tbl_studentinfo.lastname LIKE '$whatsearch%' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                       $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id 
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' AND tbl_studentinfo.firstname LIKE '$whatsearch%' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total 
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id   
                          WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' AND tbl_studentinfo.firstname LIKE '$whatsearch%'";
                      ...
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id 
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' AND tbl_studentinfo.firstname LIKE '$whatsearch%' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                       $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id 
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' AND tbl_studentinfo.gradelevel LIKE '$gradelevels%' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total 
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id   
                          WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' AND tbl_studentinfo.gradelevel LIKE '$gradelevels%'";
                      ...
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id 
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND remove='$remove')) AND tbl_remarks.scholars='$scholar' AND tbl_remarks.academic_id='$renew_id' AND tbl_studentinfo.gradelevel LIKE '$gradelevels%' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title"> List of Removed SHS Educational Assistance Recipients</h4>
                  <table class="table">
                      <thead>
                        <tr>
                          <th style="width:5%;">#</th>
                          ...
                          <th style="width:15%;">Barangay</th>
                           ...
                           if($_SESSION['usertype']=="superadmin"){
                            echo '<th style="width:20%;">Remarks</th>
                            <th style="width:10%;">Action</th>';
                           }else{
                             echo '<th style="width:30%;">Remarks</th>';
                           }
        ...
        echo '&nbsp<a href="viewRenewRequirements.php?id=';
      echo $row['id'];
                      ...
                      <?php
                        if($_SESSION['page']<=1){
                          echo '<button class="btn btn-warning" disabled>Previous</button>';
                           ...
                           echo '<a href="scholarremove_back.php" class="btn btn-warning" >Previous</a>';
                        }
                      ?>
                       <?php echo ($off+1)."-".$count.'/'.$total?>
                        ...
                        if($count>=$total){
                          echo '<button class="btn btn-primary" disabled>Next</button>';
                           ...
                           echo '<a href="scholarremove_next.php" class="btn btn-primary">Next</a>';
                        }
                      ?>
