...
$result = $conn->query($sql);
  if ($result->num_rows > 0){
    ...
    $sql7 = "SELECT * FROM tbl_shs_grade WHERE user_id='$userid'";
    $result7 = $conn->query($sql7);
    if ($result7->num_rows > 0){
      $row7 = $result7->fetch_assoc();
        $first1=$row7['grade11_1'];
        $first2=$row7['grade11_2'];
        $second1=$row7['grade12_1'];
        $second2=$row7['grade12_2'];
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                         <div class="form-group">
                            <label for="grant"> Grade 11 - 1st Sem</label>
                             <div class="input-group">
                      ...
                      <div class="col-md-3">
                         <div class="form-group">
                            <label for="grant"> Grade 11 - 2nd Sem</label>
                             <div class="input-group">
                       ...
                       <div class="col-md-3">
                         <div class="form-group">
                            <label for="grant"> Grade 12 - 1st Sem</label>
                             <div class="input-group">
                      ...
                      <div class="col-md-3">
                         <div class="form-group">
                            <label for="grant"> Grade 12 - 2nd Sem</label>
                             <div class="input-group">
