...
if(($_SESSION['studenttype']!="collegerecipient")||($_SESSION['pages']!="reportcurrent-collegerecipient")){

 
    
         $_SESSION['studenttype']="collegerecipient";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="reportcurrent-collegerecipient";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Reports > Scholars & Recipients </h4>
            ...
            <div class="row">
                  ...
                  if($order=="ASC"){
                     $none="NONE";
                       $sql = "SELECT tbl_admin.id,tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.school,tbl_studentinfo.course,tbl_studentinfo.barangay
                        ...
                        WHERE tbl_admin.typescholar !='$none' AND tbl_admin.status ='$status' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;

                         $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        FROM tbl_admin 
                        INNER JOIN tbl_studentinfo 
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE  tbl_admin.typescholar !='$none'  AND tbl_admin.status ='$status'";
                  }else{
                   $sql = "SELECT tbl_admin.id,tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.school,tbl_studentinfo.course,tbl_studentinfo.barangay
                        FROM tbl_admin 
                        INNER JOIN tbl_studentinfo 
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.typescholar !='$none' AND tbl_admin.status ='$status' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                ...
                $academic=$rowa['id'];
                  ...
                  if($order=="ASC"){
                     $sql = "SELECT tbl_admin.id,tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.school,tbl_studentinfo.course,tbl_studentinfo.barangay
                        ...
                        INNER JOIN tbl_studentinfo 
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.academic_id ='$academic' AND tbl_admin.typescholar='$scholarship' AND tbl_admin.status ='$status' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;

                    $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        FROM tbl_admin 
                        INNER JOIN tbl_studentinfo 
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.academic_id ='$academic' AND tbl_admin.typescholar='$scholarship' AND tbl_admin.status ='$status'";
                  }else{
                     $sql = "SELECT tbl_admin.id,tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.school,tbl_studentinfo.course,tbl_studentinfo.barangay
                        FROM tbl_admin 
                        INNER JOIN tbl_studentinfo 
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.academic_id ='$academic' AND tbl_admin.typescholar='$scholarship' AND tbl_admin.status ='$status' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title"> List of Scholars and Recipients</h4>
                    <table class="table">
                      <thead>
                        <tr>
                           <th style="width:5%;">#</th>
