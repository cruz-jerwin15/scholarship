            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Report Scholars & Recipients > Transfer Report </h4>
              ...
              <div class="col-md-8 ">
                <div class="page-header-toolbar">
                     ...
                     <button type="button" class="btn btn-dark btn-fw" data-toggle="modal" data-target="#modalDetailed" >Download Transfer Reports</button>
                  &nbsp
              ...
              <div class="col-md-12"><hr></div>
               <form  action="getTransferReport.php" method="post">
              <div class="col-md-12">
                <!-- <div class="page-header-toolbar"> -->
                  <div class="row">
                    <div class="col-md-3">
            ...
            <div class="row">
                  ...
                  if($_SESSION['whatsearch']=="ALL"){
                              if($order=="ASC"){
                                  $sql = "SELECT tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.middlename,tbl_studentinfo.lastname,tbl_studentinfo.barangay,tbl_studentinfo.phone
                                      ...
                                      JOIN tbl_remarks
                                      ON tbl_admin.id=tbl_remarks.user_id
                                      WHERE tbl_remarks.process='$process' AND tbl_remarks.scholars='$scholarship'
                                       ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                            ...
                            if($order=="ASC"){
                                ...
                                $acad = $row2['id'];
                                   $sql = "SELECT tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.middlename,tbl_studentinfo.lastname,tbl_studentinfo.barangay,tbl_studentinfo.phone
                                      ...
                                      JOIN tbl_remarks
                                      ON tbl_admin.id=tbl_remarks.user_id
                                      WHERE tbl_remarks.process='$process' AND tbl_remarks.scholars='$scholarship' AND tbl_remarks.academic_id='$acad'
                                       ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title">List of Transfered Full Scholars and Recipients</h4>
                    <table class="table">
                      <thead>
                        <tr>
                          <th style="width:5%;">#</th>
                      ...
                      <?php
                        if($_SESSION['page']<=1){
                          echo '<button class="btn btn-warning" disabled>Previous</button>';
                           ...
                           echo '<a href="reportstransfer_back.php" class="btn btn-warning" >Previous</a>';
                        }
                      ?>
                       <?php echo ($off+1)."-".$count.'/'.$total?>
                        ...
                        if($count>=$total){
                          echo '<button class="btn btn-primary" disabled>Next</button>';
                           ...
                           echo '<a href="reportstransfer_next.php" class="btn btn-primary">Next</a>';
                        }
                      ?>
