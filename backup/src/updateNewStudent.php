  ...
  <body onload="initLoad()">
    <div class="container-scroller">
                    ...
                    if($_SESSION['studenttype']=="fullscholar"){
                      ...
                      <div class="form-group">
                        ...
                        if($school=="La Consolacion College Tanauan"){
                         ...
                         if($school=="FIRST College"){
                             echo '<option value="FIRST College" selected="selected">FIRST College</option>';
                          }else{
                             echo '<option value="FIRST College">FIRST College</option>';
                          }
                     ...
                     if($_SESSION['studenttype']=="fullscholar"){
                          echo '<div class="col-md-12">';
                            echo '<div class="form-group">';
                              echo '<label >Exam Rating</label>';
                                echo '<input type="number" name="exam_rating" class="form-control" placeholder="Exam Rating" required="true" step="0.00001" value="';
                                echo $exam;
                                echo '">';
     ...
     <?php
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-8">
                              <div class="row">
                                  <div class="col-md-12">
                                      <div class="form-group">
									  <input type="hidden" name="gradelevel" value="<?php echo $years?>">
                                        <input type="hidden" name="userid" value="<?php echo $userid?>">
                                        <input type="hidden" name="academic_year" value="<?php echo $academic_year?>">
                    ...
                    <form method="POST" action="familyInformations.php">
                      <div class="col-md-12">
                          <div class="row">
                  ...
                  <!-- End Personal Information -->
                    ...
                    ?>
                      ...
                      <!-- <p class="card-description"> Add class <code>.table</code> </p> -->
                            ...
                            <form  action="additionalInformations.php" method="post">
                            <div class="col-md-12">
                                  <div class="row">
...
<div class="modal fade" id="addSiblings" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <!-- Start of form -->
      <form action="registersiblingsInformations.php" method="POST">
      <div class="modal-body">
        <div class="row">
                    <input type="hidden" name="userid" value="<?php echo $userid?>">
                                <input type="hidden" name="academic_year" value="<?php echo $academic_year?>">
