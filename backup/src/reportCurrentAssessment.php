    ...
    <script>
      ...
      function getUsersApprove(id){
       ...
       function getDetailed(){
        ...
        var filters = e.value;
         window.open("currentReportsForRenewal.php?spacing="+numspacing+"&filter="+filters,"_self");
      }
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Report Scholar & Recipient > Assessment </h4>
              ...
              <div class="col-md-8 ">
                <div class="page-header-toolbar">
                     ...
                     <button type="button" class="btn btn-dark btn-fw" data-toggle="modal" data-target="#modalDetailed" >Assessment Report - For Renewal</button>
                  &nbsp
                     <button type="button" class="btn btn-success btn-fw" data-toggle="modal" data-target="#modalDetailed2" >Assessment Report - Not For Renewal</button>   
              ...
              <div class="col-md-12"><hr></div>
               <form  action="getAssessmentCurrentReport.php" method="post">
              <div class="col-md-12">
                <!-- <div class="page-header-toolbar"> -->
                  <div class="row">
                    <div class="col-md-3">
               ...
               <?php
                ...
                if($filter=="ALL"){
                      if($_SESSION['whatsearch']=="ALL"){
                              if($order=="ASC"){
                                  $sql = "SELECT tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.middlename,tbl_studentinfo.lastname,tbl_studentinfo.barangay,tbl_studentinfo.phone
                                      FROM tbl_admin 
                            ...
                            if($order=="ASC"){
                                ...
                                $acad = $row2['id'];
                                  $sql = "SELECT tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.middlename,tbl_studentinfo.lastname,tbl_studentinfo.barangay,tbl_studentinfo.phone
                                      ...
                                      JOIN tbl_renewal
                                      ON tbl_admin.academic_year=tbl_renewal.academic_year AND tbl_admin.application_no=tbl_renewal.application_no
                                      WHERE tbl_renewal.academic_id='$acad'
                                       ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                            ...
                            if($order=="ASC"){
                                ...
                                $acad = isset($row2['id']);
                                  $sql = "SELECT tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.middlename,tbl_studentinfo.lastname,tbl_studentinfo.barangay,tbl_studentinfo.phone
                                      ...
                                      JOIN tbl_renewal
                                      ON tbl_admin.academic_year=tbl_renewal.academic_year AND tbl_admin.application_no=tbl_renewal.application_no
                                      WHERE tbl_renewal.academic_id='$acad' AND tbl_admin.typescholar='$scholarship'
                                       ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                      ...
                      <?php
                        if($_SESSION['page']<=1){
                          echo '<button class="btn btn-warning" disabled>Previous</button>';
                           ...
                           echo '<a href="reportscurrentassessment_back.php" class="btn btn-warning" >Previous</a>';
                        }
                      ?>
                       <?php echo ($off+1)."-".$count.'/'.$total?>
                        ...
                        if($count>=$total){
                          echo '<button class="btn btn-primary" disabled>Next</button>';
                           ...
                           echo '<a href="reportscurrentassessment_next.php" class="btn btn-primary">Next</a>';
                        }
                      ?>
...
<div class="modal fade" id="modalDetailed" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Assessment Report - For Renewal</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
