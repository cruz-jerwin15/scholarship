...
if($_SESSION['notif']=="0"){
    ...
    echo 'alert("Email address is already existing")';
    echo '</script>';
    $_SESSION['notif']="NULL";
}else if($_SESSION['notif']=="1"){
    echo '<script language="javascript">';
    echo 'alert("Successfully retrieve user")';
    echo '</script>';
    $_SESSION['notif']="NULL";
...
<html lang="en">
  ...
  <script>
    ...
    function removeUser(){
      window.open("retrieveUser.php?id="+ids,"_self");
    }
  </script>
  </head>
  <body >
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">User/Removed User</h4>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                          require "config.php";
                          $status="REMOVED";
                          $sql = "SELECT * FROM tbl_admin WHERE status='$status' AND (usertype='admin' OR usertype='committee')";
                          ...
                          if ($result->num_rows > 0){
                              while($row = $result->fetch_assoc()){
                                ...
                                echo '<button id="';
                                echo $row['id'];
                                echo '" type="button" class="btn btn-icons btn-rounded btn-primary" onClick="getRemoveId(this.id)" data-toggle="modal" data-target="#retrieveModal">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Retrieve User</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        Press [Yes] if you want to retrieve this users.
      </div>
