...
if (($_SESSION['studenttype'] != "fullscholar") || ($_SESSION['pages'] != "interview-fullscholar")) {
  $_SESSION['studenttype'] = "fullscholar";
  $_SESSION['search'] = "ALL";
  $_SESSION['pages'] = "interview-fullscholar";
  $_SESSION['whatsearch'] = "";
  $_SESSION['order'] = "ASC";
  $_SESSION['limit'] = 10;
  $_SESSION['offset'] = 1;
...
<head>
  ...
  <script>
    ...
    function getRemoveIds(id) {
      document.getElementById('removeids').value = id;
    }
...
<body>
          ...
          <div class="row page-title-header">
            <div class="col-12">
              <div class="page-header">
                <h4 class="page-title">For Interview > College Full Scholarship </h4>
                      ...
                      <tbody style="font-size:9px;">
                        ...
                        while ($row = $result->fetch_assoc()) {
                          ...
                          if ($_SESSION['select'] == "ALL") {
                            ...
                            $statusx = "OPEN";
                            $sqlx = "SELECT * FROM tbl_student_exam WHERE academic_id='$acads' AND user_id='$user_id'";
                          ...
                          if ($resultx->num_rows > 0) {
                            if (($rowx['status'] == "OPEN") || ($rowx['status'] == "ONGOING")) {
                              echo '<button id="';
                              echo $row['id'];
                              echo '"type="button" onClick="getRemoveId(this.id)" class="btn btn-icons btn-rounded btn-success" data-toggle="modal" data-target="#modalResetExam">
                                        <i class="fa fa-retweet" data-toggle="tooltip" data-placement="top" title="Reset exam"></i>';
                              echo '</button>';
                              echo '&nbsp';
                            } else if ($rowx['status'] == "DONE") {
                              echo '<a href="viewExam.php?id=';
                              echo $row['id'];
                              echo '" type="button" class="btn btn-icons btn-rounded btn-warning" >
                                        <i class="fa fa-file" data-toggle="tooltip" data-placement="top" title="View Exam!"></i>';
                              echo '</a>';
                              echo '&nbsp';
                            } else {
                              echo '<button id="';
                              echo $row['id'];
                              echo '"type="button" onClick="getRemoveId(this.id)" class="btn btn-icons btn-rounded btn-warning" data-toggle="modal" data-target="#modalExam">
                                        <i class="fa fa-tasks" data-toggle="tooltip" data-placement="top" title="Give exam to scholarhip applicant!"></i>';
                              echo '</button>';
                              echo '&nbsp';
                            }
                          } else {
                            ...
                            echo '<button id="';
                            echo $row['id'];
                            echo '"type="button" onClick="getRemoveIds(this.id)" class="btn btn-icons btn-rounded btn-warning" data-toggle="modal" data-target="#modalExam">
                                        <i class="fa fa-tasks" data-toggle="tooltip" data-placement="top" title="Give exam to scholarhip applicant!"></i>';
                            echo '</button>';
                            echo '&nbsp';
                          }
  ...
  <div class="modal fade" id="modalResetExam" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Reset Exam</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="resetExamApplicant.php" method="post">
          <div class="modal-body">

            <div class="col-md-12">
              <p>
                Note:<span style="color:red;">Do you want to reset examination? You cannot undo this action after you press [Reset] button.</span>
              </p>
  ...
  <div class="modal fade" id="modalExam" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Set Exam</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="setExamApplicant.php" method="post">
          <div class="modal-body">

            <div class="col-md-12">
              <p>
                Note:<span style="color:red;">You cannot undo this action after you press [Set] button.</span>
              </p>
              <input type="hidden" name="users" id="removeids" value="">
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label>Choose Start Date</label>
                <input type="date" name="startdates" class="form-control">
              </div>
  ...
  <div class="modal fade" id="modalRemove" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="removeInterviewFullScholar.php" method="post">
          <div class="modal-body">
            <div class="col-md-12">
              <p>
