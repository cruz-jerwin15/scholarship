        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row page-title-header">
              <div class="col-8">
                <div class="page-header">
                  <h4 class="page-title">Settings / Point System (College Scholarship)</h4>
                  
                </div>
              </div>
              <div class="col-4">
                <div class="page-header">
                  <a href="Criteria_PDF_as_of_June_7_2021_College_Scholars.pdf" target="_blank"class="btn btn-success">Download Criteria</a>
            ...
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Point System</h4>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                          ...
                          $status="APPROVED";
                          $usertype="admin";
                          $sql = "SELECT * FROM tbl_point_system";
                          ...
                          if ($result->num_rows > 0){
                              while($row = $result->fetch_assoc()){
                                ...
                                echo '</td>';
                                echo '<td>';
                                echo $row['point_system'];
                                echo '</td>';
                                echo '<td>';
                                 echo '<button id="';
                                echo $row['id'];
                                echo '" type="button" class="btn btn-icons btn-rounded btn-success"  data-toggle="modal" data-target="#editPoint';
                                 echo $row['id'];
                                echo '">
             ...
             <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Exam Indicators</h4>
                    <!-- <p class="card-description"> Add class <code>.table</code> </p> -->
                    <table class="table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <?php
                          ...
                          $status="APPROVED";
                          $usertype="admin";
                          $sql = "SELECT * FROM tbl_exam_indicator ORDER BY points DESC";
                          $result = $conn->query($sql);
                          $count=1;
                          if ($result->num_rows > 0){
                              while($row = $result->fetch_assoc()){
                                ...
                                echo '<td>';
                                 echo '<button id="';
                                echo $row['id'];
                                echo '" type="button" class="btn btn-icons btn-rounded btn-success"  data-toggle="modal" data-target="#editExam';
                                 echo $row['id'];
                                echo '">
                                  <i class="fa fa-pencil"></i></button>&nbsp';
                                //     echo '<button id="';
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                          ...
                          $status="APPROVED";
                          $usertype="admin";
                          $sql = "SELECT * FROM tbl_grade_indicator ORDER BY points DESC";
                          $result = $conn->query($sql);
                          $count=1;
                          if ($result->num_rows > 0){
                              while($row = $result->fetch_assoc()){
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                          ...
                          $status="APPROVED";
                          $usertype="admin";
                          $sql = "SELECT * FROM tbl_income_indicator ORDER BY points DESC";
                          $result = $conn->query($sql);
                          $count=1;
                          if ($result->num_rows > 0){
                              while($row = $result->fetch_assoc()){
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                          ...
                          $status="APPROVED";
                          $usertype="admin";
                          $sql = "SELECT * FROM tbl_residency_indicator ORDER BY points DESC";
                          $result = $conn->query($sql);
                          $count=1;
                          if ($result->num_rows > 0){
                              while($row = $result->fetch_assoc()){
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                          ...
                          $status="APPROVED";
                          $usertype="admin";
                          $sql = "SELECT * FROM tbl_other_indicator ORDER BY points DESC";
                          $result = $conn->query($sql);
                          $count=1;
                          if ($result->num_rows > 0){
                              while($row = $result->fetch_assoc()){
...
echo '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <!-- Start of form -->
      <form action="updatePointSystem.php" method="POST">
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
...
$status1="APPROVED";
$usertype1="admin";
$sql1 = "SELECT * FROM tbl_grade_indicator ORDER BY points DESC";
$result1 = $conn->query($sql1);
...
$status1="APPROVED";
$usertype1="admin";
$sql1 = "SELECT * FROM tbl_income_indicator ORDER BY points DESC";
$result1 = $conn->query($sql1);
...
$status1="APPROVED";
$usertype1="admin";
$sql1 = "SELECT * FROM tbl_residency_indicator ORDER BY points DESC";
$result1 = $conn->query($sql1);
...
$status1="APPROVED";
$usertype1="admin";
$sql1 = "SELECT * FROM tbl_other_indicator ORDER BY points DESC";
$result1 = $conn->query($sql1);
