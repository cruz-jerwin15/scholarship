...
if(($_SESSION['studenttype']!="shscholar")||($_SESSION['pages']!="current-shscholar")){

  if($_SESSION['pages']!="assessnotif-shscholar"){
     if($_SESSION['pages']!="renewnotif-shscholar"){
          $_SESSION['studenttype']="shscholar";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="current-shscholar";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
            ...
            <div class="row">
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title"> List of Senior High School Current Recipients </h4>
                    <table class="table">
                      <thead>
                        <tr>
                            <th style="width:5%;">#</th>
                          ...
                          <th style="width:14%;">Grade & Track</th>
         ...
         <div class="col-md-12">
          <div class="form-group">
            ...
            <select name="filter-assess" id="filter-assess" class="form-control">
			  ...
			  <option name="GRADE 11">GRADE 11</option>
			  <option name="GRADE 12">GRADE 12</option>
            </select>
          </div>
           <div class="form-group">
