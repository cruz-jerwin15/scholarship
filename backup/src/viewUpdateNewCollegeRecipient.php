...
$result = $conn->query($sql);
  if ($result->num_rows > 0){
    ...
    $sql7 = "SELECT * FROM tbl_whatschool WHERE userid='$userid'";
    $result7 = $conn->query($sql7);
    if ($result7->num_rows > 0){
      $row7 = $result7->fetch_assoc();
        $schoolname=$row7['school'];
        $courses=$row7['course'];
        $yearlevel=$row7['years'];
        $schooltype=$row7['schooltype'];
    }else{
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                   <h4 class="page-title">New College Recipient Applicant Information</h4>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                             <div class="row">
                                <form action="updatenewcollegerecipientprofile.php" method="post" enctype="multipart/form-data">
                               <div class="col-md-6">
                      ...
                      <div class="col-md-8">
                       <div class="row">
                          <div class="col-md-4">
                             <form action="updateNewCollegeRecipientInfo.php" method="POST">
                      ...
                      <div class="col-md-12">
                        <hr>
                          ...
                          <div class="col-md-12">
                           <div class="form-group">
                            <form action="updateNewCollegeRecipientFamilyInfo.php" method="POST">
                               <input type="hidden" name="userid" value="<?php echo $userid;?>">
                      ...
                      <div class="col-md-12">
                         <div class="form-group">
                          <form action="updateNewCollegeRecipientEducationalInfo.php" method="POST">
                               <input type="hidden" name="userid" value="<?php echo $userid;?>">
                      ...
                      <div class="col-md-3">
                         <div class="form-group">
                            ...
                            <div class="input-group">
                              <input type="text" name="highest" id="schooladdress" class="form-control" placeholder="Ex. Grade 10/1st Year" value="<?php echo $highestyear; ?>" >
                      ...
                      <div class="col-md-12"><hr></div>
                       <div class="col-md-12">
                         <div class="form-group">
                          <form action="updateNewCollegeRecipientSchoolIntended.php" method="POST">
                               <input type="hidden" name="userid" value="<?php echo $userid;?>">
                            <label for="school">School Intended To Enrol</label>
                          </div>
                      </div>
                       <div class="col-md-3">
                         <div class="form-group">
                          <label for="grant"> School Name</label>
                            <div class="input-group">
                                 <input type="text" id="schoolintended" name="schoolintended" class="form-control" placeholder="School name" value="<?php echo $schoolname; ?>" >
                            </div>
                          </div>
                      </div> 
                       <div class="col-md-3">
                         <div class="form-group">
                          <label for="schooltype">School Type</label>
                            <div class="input-group">
                              <select type="text" name="schooltype" id="schooltype" class="form-control">
                                 <?php
                                  if($schooltype=="Private"){
                                    ...
                                    echo '<option value="Private">Private</option>
                                          <option value="State" selected>State University</option>';
                                  }
                                 ?>
                      ...
                      <div class="col-md-3">
                         <div class="form-group">
                          <label for="course"> Course</label>
                            <div class="input-group">
                                 <input type="text" id="course" name="course" class="form-control" placeholder="Course" value="<?php echo $courses; ?>" >
                            </div>
                          </div>
                      </div> 
                      <div class="col-md-3">
                         <div class="form-group">
                          <label for="yearlevel">Year Level</label>
                            <div class="input-group">
                              <select type="text" name="yearlevel" id="yearlevel" class="form-control">
                                  <?php
                                  if($yearlevel=="1st"){
                                    echo ' <option value="1st" selected>1st</option>
                            ...
                            <div class="col-md-6">
                              <div class="row">
                                 <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                    <input type="submit" class="btn btn-dark" value="Update School Intended To Enrol">
                                  </form>
                                  </div>
                              </div>
...
echo '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="updateSiblingsNewRecipient.php" method="post">
...
echo '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     <form action="removeSiblingsNewRecipient.php" method="post">
      <div class="modal-header">
...
<div class="modal fade" id="addSiblings" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <!-- Start of form -->
      <form action="addSiblingsRecipient.php" method="POST">
      <div class="modal-body">
        <div class="row">
