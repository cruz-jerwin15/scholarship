...
if(($_SESSION['studenttype']!="collegerecipient")||($_SESSION['pages']!="renewcurrent-collegerecipient")){

  if($_SESSION['pages']!="renewnotif-collegerecipient"){

        $_SESSION['studenttype']="collegerecipient";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="renewcurrent-collegerecipient";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
          ...
          <div class="content-wrapper">
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Renewal Recipients >College Educational Assistance  (<?php echo $category?>)</h4>
            ...
            <!--   <div class="col-md-8 ">
              ...
              <div class="col-md-12"><hr></div>
               <form  action="getRenewSearch.php" method="post">
              <div class="col-md-12">
                <!-- <div class="page-header-toolbar"> -->
                  <div class="row">
                    <div class="col-md-3">
      ...
      // if ($resultg->num_rows <= 0){
           echo '&nbsp;<button id="';
                ...
                echo '" type="button" onClick="getRenew(this.id)" style="background-color:#2f54eb;" class="btn btn-icons btn-rounded btn-success" data-toggle="modal" data-target="#renewStudent">';
                  echo '<i class="fa fa-check" data-toggle="tooltip" data-placement="top" title="Click to add this scholars to current scholars!"></i>';
                    echo '</button>&nbsp';
      // }
                      ...
                      <?php
                        if($_SESSION['page']<=1){
                          echo '<button class="btn btn-warning" disabled>Previous</button>';
                           ...
                           echo '<a href="renew_current_back.php" class="btn btn-warning" >Previous</a>';
                        }
                      ?>
                       <?php echo ($off+1)."-".$count.'/'.$total?>
                        ...
                        if($count>=$total){
                          echo '<button class="btn btn-primary" disabled>Next</button>';
                           ...
                           echo '<a href="renew_current_next.php" class="btn btn-primary">Next</a>';
                        }
                      ?>
...
<div class="modal fade" id="renewStudent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Send Scholars to Current</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
       <form action="sendScholars.php" method="post">
      <div class="modal-body">
         <div class="row">
          <div class="col-md-12">

                <input type="hidden" name="userid" id="renewid">
               <p>Please click SUBMIT if you want to send this scholars to current scholars.</p>
          </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form action="renew_removeScholars.php" method="post">
      <div class="modal-body">
         <div class="col-md-12">
            <p>
...
if($filter=="ALL"){
  if($order=="ASC"){
   ...
   while($row = $result->fetch_assoc()){
       $statusa="OPEN";
        $sqla = "SELECT * FROM tbl_assesment WHERE status='$statusa'";
        $resulta = $conn->query($sqla);
        $rowa = $resulta->fetch_assoc();
        $academic_id=$rowa['id'];
      $academic_year=$row['academic_year'];
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            ...
            echo $rowc['academic_year']." / ".$rowc['semester']." semester";
