...
if(($_SESSION['studenttype']!="fullscholar")||($_SESSION['pages']!="current-fullscholar")){

  if($_SESSION['pages']!="assessnotif-fullscholar"){
     if($_SESSION['pages']!="renewnotif-fullscholar"){
          $_SESSION['studenttype']="fullscholar";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="current-fullscholar";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
          ...
          <div class="content-wrapper">
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Current Scholars > College Full Scholarship </h4>
            ...
            <div class="row">
              <!-- Tabe here -->
               ...
               if($filter=="ALL"){
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.gradelevel
                        ,tbl_studentinfo.course,tbl_studentinfo.bday,tbl_studentinfo.school
                        FROM tbl_admin
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title"> List of College Current Scholars </h4>
                    <table class="table">
                      <thead>
                        <tr>
                           <th style="width:5%;">#</th>
