...
if($process=="EXAM"){
	...
	$sql = "UPDATE tbl_grade_indicator_a SET label='$label',points='$points',min='$min',max='$max' WHERE id='$id'";
	$conn->query($sql);
	 echo '<script language="javascript">';
	...
	$sql = "UPDATE tbl_income_indicator_a SET label='$label',points='$points',min='$min',max='$max' WHERE id='$id'";
	$conn->query($sql);
	 echo '<script language="javascript">';
	...
	$sql = "UPDATE tbl_residency_indicator_a SET label='$label',points='$points',min='$min',max='$max' WHERE id='$id'";
	$conn->query($sql);
	 echo '<script language="javascript">';
	...
	$sql = "UPDATE tbl_other_indicator_a SET points='$points' WHERE id='$id'";
	$conn->query($sql);
	 echo '<script language="javascript">';
	...
	echo '<script language="javascript">';
		// echo 'localStorage.setItem("notif","1")';
  		echo 'window.open("pointSystemAssistance.php","_self")';
  		echo '</script>';
