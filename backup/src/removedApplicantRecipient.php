...
if(($_SESSION['studenttype']!="collegerecipient")||($_SESSION['pages']!="removeapplicant-collegerecipient")){



          $_SESSION['studenttype']="collegerecipient";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="removeapplicant-collegerecipient";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Removed Applicant >  College Educational Assistance  (<?php echo $category?>) </h4>
            ...
            <div class="row">
              <!-- Tabe here -->
               <?php
                ...
                if($filter=="ALL"){
                  if($order=="ASC"){
                    $sql ="SELECT * FROM tbl_remarks WHERE scholars='$scholar' AND remove='$remove' AND academic_id='$academic_id' ORDER BY user_id ASC LIMIT ".$limit." OFFSET ".$off;

                    $sql1 ="SELECT COUNT(DISTINCT(user_id)) as total FROM tbl_remarks WHERE scholars='$scholar' AND remove='$remove'  AND academic_id='$academic_id'";
                  }else{
                    $sql ="SELECT * FROM tbl_remarks WHERE scholars='$scholar' AND remove='$remove' ORDER BY user_id DESC LIMIT ".$limit." OFFSET ".$off;

                    $sql1 ="SELECT COUNT(DISTINCT(user_id)) as total FROM tbl_remarks WHERE scholars='$scholar' AND remove='$remove'";
                  }


              }else if($filter=="EMAIL"){
                if($order=="ASC"){
                  $sql = "SELECT tbl_admin.id as user_id,tbl_admin.username,tbl_studentinfo.school,tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.phone,tbl_studentinfo.barangay,tbl_remarks.remarks
                  FROM tbl_admin
                  ...
                  WHERE tbl_remarks.academic_id='$academic_id' AND tbl_remarks.scholars='$scholar' AND tbl_admin.username LIKE '%$whatsearch%' AND tbl_remarks.remove='$remove'";
                   ...
                   $sql = "SELECT tbl_admin.id,tbl_admin.username,tbl_studentinfo.school,tbl_studentinfo.middlename,tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.phone,tbl_studentinfo.barangay,tbl_remarks.remarks
                  FROM tbl_admin
                  INNER JOIN tbl_remarks
                  ON tbl_admin.id=tbl_remarks.user_id
                  JOIN tbl_studentinfo
                ...
                if($order=="ASC"){
                  $sql = "SELECT tbl_admin.id as user_id,tbl_admin.username,tbl_studentinfo.school,tbl_studentinfo.middlename,tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.phone,tbl_studentinfo.barangay,tbl_remarks.remarks
                  FROM tbl_admin
                  INNER JOIN tbl_remarks
                  ON tbl_admin.id=tbl_remarks.user_id
                  JOIN tbl_studentinfo
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title"> List of Removed College Educational Assistance Applicants</h4>
                    <table class="table">
                      <thead>
                        <tr>
                          <th style="width:5%;">#</th>
                      ...
                      <tbody style="font-size:9px;">
                        ...
                        if($filter=="ALL"){
                            while($row = $result->fetch_assoc()){
                              $user_id=$row['user_id'];
                               $sql2 = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.school
                              FROM tbl_admin
