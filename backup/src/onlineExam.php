...
$exam_start=$_SESSION['exam_start'];
...
if($exam_start=="NO"){
    ...
    if(($diff<=0)&&($diff2<=0)){
        ...
        echo '<script language="javascript">';
              echo 'alert("Your exam was scheduled on '.$start_date;
              echo ' and will be due on '.$due_date;
              echo '")';
              echo '</script>';
    echo '<script language="javascript">';
...
if($exam_start=="YES"){
    $sql5 = "SELECT * FROM tbl_exam_section WHERE exam_id='$exam_id' LIMIT 1 offset ".$exam_number;
...
.btn:active {
    ...
    <script type="text/javascript">
        ...
        //    var answer = answers.replace("http://ydocityofstotomas-scholarship.org.ph:8001/ydo/src/questimage/","");
           // var answer = answers.replace("http://192.168.1.15/backup/src/questimage/","");
           var answer;
            var newid;
             if(id.includes("choiceA")){
                answer="A";
        ...
        //   var answer = answers.replace("http://ydocityofstotomas-scholarship.org.ph:8001/ydo/src/questimage/","");
          ...
          // alert(answer);
           var newid;
            if(id.includes("choiceAA")){
                answer="A";
               newid = id.replace("choiceAA", "");
               document.getElementById("choiceAA"+newid).style.border="0px";
               document.getElementById("choiceAA"+newid).style.border="5px solid #ff0000";

               document.getElementById("choiceBB"+newid).style.border="0px";
               document.getElementById("choiceCC"+newid).style.border="0px";
               document.getElementById("choiceDD"+newid).style.border="0px";
               document.getElementById("choiceEE"+newid).style.border="0px";
            }else if(id.includes("choiceBB")){
                answer="B";
               newid = id.replace("choiceBB", "");
               document.getElementById("choiceBB"+newid).style.border="0px";
               document.getElementById("choiceBB"+newid).style.border="5px solid #ff0000";

               document.getElementById("choiceAA"+newid).style.border="0px";
               document.getElementById("choiceCC"+newid).style.border="0px";
               document.getElementById("choiceDD"+newid).style.border="0px";
               document.getElementById("choiceEE"+newid).style.border="0px";
            }else if(id.includes("choiceCC")){
                answer="C";
               newid = id.replace("choiceCC", "");
               document.getElementById("choiceCC"+newid).style.border="0px";
               document.getElementById("choiceCC"+newid).style.border="5px solid #ff0000";

               document.getElementById("choiceAA"+newid).style.border="0px";
               document.getElementById("choiceBB"+newid).style.border="0px";
               document.getElementById("choiceDD"+newid).style.border="0px";
               document.getElementById("choiceEE"+newid).style.border="0px";
            }else if(id.includes("choiceDD")){
                answer="D";
               newid = id.replace("choiceDD", "");
               document.getElementById("choiceDD"+newid).style.border="0px";
               document.getElementById("choiceDD"+newid).style.border="5px solid #ff0000";

               document.getElementById("choiceAA"+newid).style.border="0px";
               document.getElementById("choiceCC"+newid).style.border="0px";
               document.getElementById("choiceBB"+newid).style.border="0px";
               document.getElementById("choiceEE"+newid).style.border="0px";
            }else if(id.includes("choiceEE")){
                answer="E";
               newid = id.replace("choiceEE", "");
               document.getElementById("choiceEE"+newid).style.border="0px";
               document.getElementById("choiceEE"+newid).style.border="5px solid #ff0000";
         ...
         echo '<div class="d-flex justify-content-center row">
            <div class="col-md-10 col-lg-10">
                <div class="border">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                           <div class="col-md-12">';
                                                echo '<div class="row">';
                                                    echo '<div class="col-md-12">';
                                                     echo '<p>A.<img id="choiceAA';
                                                     echo $row8['id'];
                                                     echo '" onClick="getAnswer3(this.id)" style="height:75px;" src="questimage/';
                                                      echo $choice_a;
                                                      echo '"></p>';
                                                    echo '</div>';
                    ...
                    echo '<form id="myForm" action="sendExam.php" method="POST" enctype="multipart/form-data" >';
                    ...
                    echo '<div class="d-flex flex-row justify-content-between p-3 bg-white" style="text-align:right;"><button class="btn btn-primary border-success align-items-center btn-success" id="submit_answer" type="submit">Submit<i class="fa fa-angle-right ml-2"></i></button></div>
                    </form>
                </div>
            </div>
        </div>
