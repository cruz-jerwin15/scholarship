            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Current College Full Scholar</h4>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                             <div class="row">
                                <form action="updatecollegefullprofile.php" method="post" enctype="multipart/form-data">
                               <div class="col-md-6">
                      ...
                      <div class="col-md-8">
                       <div class="row">
                          <div class="col-md-4">
                             <form action="updateCollegeFullInfo.php" method="POST">
                      ...
                      <div class="col-md-12">
                        <hr>
                          ...
                          <div class="col-md-12">
                           <div class="form-group">
                            <form action="updateCollegeFullFamilyInfo.php" method="POST">
                               <input type="hidden" name="userid" value="<?php echo $userid;?>">
                      ...
                      <div class="col-md-12">
                         <div class="form-group">
                          <form action="updateCollegeFullEducationalInfo.php" method="POST">
                               <input type="hidden" name="userid" value="<?php echo $userid;?>">
...
echo '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="updateSiblingFull.php" method="post">
...
echo '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     <form action="removeSiblingFull.php" method="post">
      <div class="modal-header">
