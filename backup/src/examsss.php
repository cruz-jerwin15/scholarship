         ...
         echo '<div class="d-flex justify-content-center row">
            <div class="col-md-10 col-lg-10">
                <div class="border">
                    ...
                    echo '<div class="d-flex flex-row justify-content-between p-3 bg-white" style="text-align:right;"><a class="btn btn-primary border-success align-items-center btn-success" id="submit_answer" href="sendExam1.php">Next<i class="fa fa-angle-right ml-2"></i></a></div>
