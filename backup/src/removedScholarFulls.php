...
if(($_SESSION['studenttype']!="fullscholar")||($_SESSION['pages']!="removescholars-fullscholar")){

 
    
          $_SESSION['studenttype']="fullscholar";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="removescholars-fullscholar";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Removed Scholars > College Full Scholarship </h4>
            ...
            <div class="row">
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title"> List of Removed College Scholars</h4>
                   <table class="table">
                      <thead>
                        <tr>
                          <th style="width:5%;">#</th>
