...
if(($_SESSION['studenttype']!="fullscholar")||($_SESSION['pages']!="renewcurrent-fullscholar")){

  if($_SESSION['pages']!="renewnotif-fullscholar"){
   
        $_SESSION['studenttype']="fullscholar";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="renewcurrent-fullscholar";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Renewal Scholars > College Full Scholarship </h4>
