...
if(($_SESSION['studenttype']!="fullscholar")||($_SESSION['pages']!="assesscurrent-fullscholar")){

  if($_SESSION['pages']!="assessnotif-fullscholar"){

          $_SESSION['studenttype']="fullscholar";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="assesscurrent-fullscholar";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Assessment Scholars > College Full Scholarship </h4>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <div class="col-md-12">
            <p>
              Note:<span style="color:red;">This student will transfer to college financial assistance.</span>
            </p>
         </div>
              ...
              <div class="form-group">
                <label >Grade Remarks</label>
                  <select class="form-control" name="grade" required>
                    <option value="No Grade Below 80">No Grade Below 80</option>
                    <option value="With Grade Below 80">With Grade Below 80</option>
