...
if(($_SESSION['studenttype']!="collegerecipient")||($_SESSION['pages']!="assessnotif-collegerecipient")){
 $_SESSION['studenttype']="collegerecipient";
  $_SESSION['search']="ALL";
  $_SESSION['pages']="assessnotif-collegerecipient";
  $_SESSION['whatsearch']="";
  $_SESSION['order']="ASC";
  $_SESSION['limit']=10;
  $_SESSION['offset']=1;
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Assessment Notification > College Recipient </h4>
               ...
               <?php
                ...
                $limit = 10;
                      $sql = "SELECT tbl_admin.id as adminid,tbl_assess_req.id,tbl_assess_req.academic_year,tbl_assess_req.application_no,tbl_assess_req.school_id,tbl_assess_req.registration_form,tbl_assess_req.school_clearance,tbl_assess_req.gradereport 
                        ...
                        ON tbl_assess_req.academic_year=tbl_admin.academic_year AND tbl_assess_req.application_no=tbl_admin.application_no WHERE (tbl_assess_req.school_id='$stats' OR tbl_assess_req.registration_form='$stats' OR tbl_assess_req.school_clearance='$stats'  OR tbl_assess_req.gradereport='$stats') AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' ORDER BY tbl_assess_req.id ASC LIMIT ".$limit." OFFSET ".$off;
                        ;
                       ...
                       $sql1 = "SELECT COUNT(tbl_assess_req.id) as total 
                        ...
                        WHERE (tbl_assess_req.school_id='$stats' OR tbl_assess_req.registration_form='$stats' OR tbl_assess_req.school_clearance='$stats'  OR tbl_assess_req.gradereport='$stats') AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar'";
                                ...
                                $count++;
                                 echo '<tr>';
                                  ...
                                  echo '<td style="width:15%;"><center>';
                                     echo '<button id="';
                                          echo $row['adminid'];
                                          echo '" type="button" class="btn btn-icons btn-rounded btn-primary" onClick="gotoExisting(this.id)">
                                            <i class="fa fa-file-o" data-toggle="tooltip" data-placement="top" title="Click to transfer to existing college financial assistance"></i>';
                                             echo '</button>';
                                  echo '</center></td>';
                                  echo '</tr>';
                             }
