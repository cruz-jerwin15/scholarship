  ...
  <head>
    ...
    <script>
      ...
      function getAssessment(){
        window.open("collegeFullScholarReport.php","_blank");
      }
    </script>
  </head>
  <body>
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title"> For Assessment > College FullScholar </h4>
                      ...
                      <?php
                        $status="ASSESSMENT";
                         ...
                         $sql15 = "SELECT COUNT(*) as college FROM tbl_admin WHERE status='$status' AND usertype='$user' AND typescholar='$scholar'";
                            ...
                            echo  '<h4 class="card-title"> List of College FullScholar for Assessment (Total Numbers: ';
                            echo $row15['college'];
                            echo ' recipients)</h4>';
                      ?>
