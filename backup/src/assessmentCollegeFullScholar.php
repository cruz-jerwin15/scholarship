...
if (($_SESSION['studenttype'] != "fullscholar") || ($_SESSION['pages'] != "assessment-fullscholar")) {
  $_SESSION['studenttype'] = "fullscholar";
  $_SESSION['search'] = "ALL";
  $_SESSION['pages'] = "assessment-fullscholar";
  $_SESSION['whatsearch'] = "";
  $_SESSION['order'] = "ASC";
  $_SESSION['limit'] = 10;
  $_SESSION['offset'] = 1;
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
          ...
          <div class="row page-title-header">
            <div class="col-12">
              <div class="page-header">
                <h4 class="page-title">For Assessment > College Full Scholarship </h4>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="page-header-toolbar">
                ...
                &nbsp
                <button type="button" class="btn btn-success btn-fw" data-toggle="modal" data-target="#modalFinal">Click to Finalize Score</button>
                &nbsp
                <button type="button" class="btn btn-dark btn-fw" data-toggle="modal" data-target="#modalDetailed">Assessment Summary Report</button>
                &nbsp

                <button type="button" class="btn btn-warning btn-fw" data-toggle="modal" data-target="#modalScholar">Official Result</button>
                &nbsp
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <select name="filter" id="filter" class="form-control">
                        ...
                        <option value="EXAM RATING">EXAM RATING</option>
        ...
        <div class="row">
          ...
          if ($filter == "ALL") {
            if ($order == "ASC") {
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.exam_rating 
                        FROM tbl_admin 
            ...
            if ($order == "ASC") {
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.exam_rating 
                        ...
                        INNER JOIN tbl_studentinfo 
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no  
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' ORDER BY tbl_studentinfo.gwa ASC LIMIT " . $limit . " OFFSET " . $off;;
              ...
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.exam_rating 
                        ...
                        INNER JOIN tbl_studentinfo 
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no  
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' ORDER BY tbl_studentinfo.gwa DESC LIMIT " . $limit . " OFFSET " . $off;;
            ...
            if ($order == "ASC") {
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.exam_rating 
                        ...
                        INNER JOIN tbl_studentinfo 
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no  
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' ORDER BY tbl_studentinfo.exam_rating ASC LIMIT " . $limit . " OFFSET " . $off;;
              ...
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.exam_rating 
                        ...
                        INNER JOIN tbl_studentinfo 
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no  
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' ORDER BY tbl_studentinfo.exam_rating DESC LIMIT " . $limit . " OFFSET " . $off;;
                    ...
                    <thead>
                      <tr>
                        ...
                        echo '<th style="width:5%;">#</th>
                            ...
                            <th style="width:10%;">G.W.A.</th>
                            <th style="width:5%;">EXAM RATING</th>
                      ...
                      <tbody style="font-size:9px;">
                        ...
                        while ($row = $result->fetch_assoc()) {
                          ...
                          if ($result12->num_rows > 0) {
                            $st = "DRAFT";
                            $sql14 = "SELECT COUNT(*) as items FROM tbl_answer_student WHERE exam_id='$exam_id' AND user_id='$userid' AND status<>'$st'";
                          ...
                          echo '</td>';
                          $sqlz = "SELECT * FROM tbl_finalscore WHERE academic_year='$academic_year' AND application_no='$application_no' AND academic_id='$acads'";
                          $resultz = $conn->query($sqlz);
                          $rowz = $resultz->fetch_assoc();
      ...
      <div class="modal-content">
        ...
        <form action="transferAssessApplicant.php" method="post">
          <div class="modal-body">
            <div class="col-md-12">
              <p>
                Note:<span style="color:red;">Transfer this applicant to College Financial Assistance.</span>
              </p>
            </div>
