...
if(($_SESSION['studenttype']!="shscholar")||($_SESSION['pages']!="assessnotif-shscholar")){
 $_SESSION['studenttype']="shscholar";
  $_SESSION['search']="ALL";
  $_SESSION['pages']="assessnotif-shscholar";
  $_SESSION['whatsearch']="";
  $_SESSION['order']="ASC";
  $_SESSION['limit']=10;
  $_SESSION['offset']=1;
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Assessment Notification > Senior High Financial Assistance </h4>
