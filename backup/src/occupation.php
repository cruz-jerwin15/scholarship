          ...
          <div class="content-wrapper">
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Settings/List of Occupation</h4>
            ...
            <div class="row">
             <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">List of Occuppation</h4>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                          ...
                          $status="APPROVED";
                          $usertype="admin";
                          $sql = "SELECT * FROM tbl_legend_occupation ORDER BY points DESC";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Remove Occupation</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="removeOccupation.php" method="POST">
      <div class="modal-body">
        <input type="hidden" id="occupationid" name="occupationid"/>
        Press [Yes] if you want to remove this occupation.
      </div>
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <!-- Start of form -->
      <form action="addOccupation.php" method="POST">
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-12">
...
$status1="APPROVED";
$usertype1="admin";
$sql1 = "SELECT * FROM tbl_legend_occupation ORDER BY points DESC";
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group row">
              ...
              echo $row1['id'];
              echo '">
               <input type="text" class="form-control" name="editoccupation" value="';
               echo $row1['legend'];
               echo '" placeholder="Enter occupation" required>
            </div>
             
          </div>
         <div class="col-sm-12">
            <div class="form-group row">
               <input type="text" class="form-control" name="editpoints" value="';
               echo $row1['points'];
               echo '" placeholder="Enter points" required>
            </div>
