          ...
          <div class="content-wrapper">
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Settings/List of Partner School</h4>
            ...
            <div class="row">
             <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">List of Partner School</h4>
                    ...
                    <table class="table">
                      <thead>
                        <tr>
                          ...
                          <th style="width:15%;">Website Link</th>
                      ...
                      <tbody>
                        <?php
                          ...
                          $status="APPROVED";
                          $usertype="admin";
                          $sql = "SELECT * FROM tbl_partnerschool ORDER BY school_name";
                          ...
                          if ($result->num_rows > 0){
                              while($row = $result->fetch_assoc()){
                                ...
                                echo '</td>';
                                  ...
                                  if(strlen($row['website'])>=50){
                                      echo substr($row['website'], 0,45)."...";
                                  }else{
                                      echo $row['website'];
                                  }
                                ...
                                echo '<td>';
                                  echo '<button id="';
                                echo $row['id'];
                                echo '" type="button" class="btn btn-icons btn-rounded btn-warning"  data-toggle="modal" data-target="#editlogo';
                                 echo $row['id'];
                                echo '">
                                  <i class="fa fa-file"></i></button>&nbsp';
                                 echo '<button id="';
                                echo $row['id'];
                                ...
                                echo '<button id="';
                                echo $row['id'];
                                echo '" type="button" class="btn btn-icons btn-rounded btn-danger" data-toggle="modal" data-target="#removeModal';
                                echo $row['id'];
                                echo '">
...
<?php
$sql1 = "SELECT * FROM tbl_partnerschool ORDER BY school_name";
...
if ($result1->num_rows > 0){
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     <form action="removePartnerSchool.php" method="POST">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Remove Partner School</h5>
      ...
      <div class="modal-body">
        ...
        echo $row1['id'];
        echo '">
        Press [Yes] if you want to remove this partner school.
      </div>
...
if ($result1->num_rows > 0){
    while($row1 = $result1->fetch_assoc()){
      echo '<div class="modal fade" id="editlogo';
      echo $row1['id'];
      echo '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     <form action="uploadSchoolLogo.php" method="POST" enctype="multipart/form-data">
      <div class="modal-header">
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Partner School</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <!-- Start of form -->
      <form action="addPartnerSchool.php" method="POST">
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-12">
          ...
          <div class="col-sm-12">
           ...
           <div class="col-sm-12">
             <div class="form-group">
               <input type="text" class="form-control" name="contactnumber" placeholder="Enter school contact number" required>
            </div>
           ...
           <div class="col-sm-12">
             <div class="form-group">
               <input type="text" class="form-control" name="website" placeholder="Enter school website link" required>
            </div>
...
echo '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Partner School Information</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <!-- Start of form -->
      <form action="updatePartnerSchool.php" method="POST">
      <div class="modal-body">
         <div class="row">
          <div class="col-sm-12">
            <div class="form-group">
              ...
              echo '">
               ...
               echo $row1['school_name'];
               echo '" placeholder="Enter school name" disabled>
            </div>
          ...
          <div class="col-sm-12">
             <div class="form-group">
               ...
               echo $row1['address'];
               echo '"placeholder="Enter school address" required>
            </div>
           ...
           <div class="col-sm-12">
             <div class="form-group">
               ...
               echo '"placeholder="Enter school contact number" required>
            </div>
           ...
           <div class="col-sm-12">
             <div class="form-group">
               ...
               echo $row1['website'];
               echo '"placeholder="Enter school website link" required>
            </div>
