...
$torange=$_GET['totalstudent'];
    ...
    $sql = "SELECT * FROM tbl_admin WHERE status='$status' AND typescholar='$scholartype' ORDER BY applicant_number LIMIT ".$torange." OFFSET ".$fromrange;
    ...
    while($row = $result->fetch_assoc()){
      ...
      if($scholartype=="collegerecipient"){
        ...
        $sql1 = "SELECT * FROM tbl_studentinfo WHERE academic_year='$academic_year' AND application_no='$application_no' AND schooltype='$schooltype'";
