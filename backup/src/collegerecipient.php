...
if(($_SESSION['studenttype']!="collegerecipient")||($_SESSION['pages']!="current-collegerecipient")){

  if($_SESSION['pages']!="assessnotif-collegerecipient"){
     if($_SESSION['pages']!="renewnotif-collegerecipient"){
          $_SESSION['studenttype']="collegerecipient";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="current-collegerecipient";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
  ...
  <head>
    ...
    <script>
      ...
      function getDetailed(){
        ...
        var filters = e.value;
         window.open("releaseGrant.php?spacing="+numspacing+"&filter="+filters+"&grant="+grant,"_self");
      }
    </script>
  </head>
  <body>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Current Recipients > College Educational Assistance  (<?php echo $category?>)</h4>
                ...
                <div class="page-header-toolbar">
                 <!-- <button type="button" class="btn btn-primary btn-fw" onClick="getAssessment()">Download Scholars Assessment Report</button> &nbsp
                  <button type="button" class="btn btn-warning btn-fw" onClick="getAssessmentNot()">Download Scholars Assessment Report - Not for Renewal</button> &nbsp -->
                   <button type="button" class="btn btn-dark btn-fw" data-toggle="modal" data-target="#modalDetailed" >Download For Grant</button>
                  &nbsp
               </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              if($filter=="ALL"){
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.bday,tbl_studentinfo.gradelevel
                        ,tbl_studentinfo.course,tbl_studentinfo.school
                        FROM tbl_admin
                        ...
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype'  AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                        ;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar'";
                     ...
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.bday,tbl_studentinfo.gradelevel
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                        ;
                  ...
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.bday,tbl_studentinfo.gradelevel
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' AND tbl_admin.username='$whatsearch' ORDER BY tbl_admin.username ASC LIMIT ".$limit." OFFSET ".$off;
                        ;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' AND tbl_admin.username='$whatsearch'";
                     ...
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.bday,tbl_studentinfo.gradelevel
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' AND tbl_admin.username='$whatsearch' ORDER BY tbl_admin.username DESC LIMIT ".$limit." OFFSET ".$off;
                        ;
                  ...
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.bday,tbl_studentinfo.gradelevel
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.lastname LIKE '$whatsearch%' ORDER BY tbl_studentinfo.lastname ASC LIMIT ".$limit." OFFSET ".$off;
                        ;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.lastname LIKE '$whatsearch%'";
                     ...
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.bday,tbl_studentinfo.gradelevel
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.lastname LIKE '$whatsearch%' ORDER BY tbl_studentinfo.lastname DESC LIMIT ".$limit." OFFSET ".$off;
                        ;
                  ...
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.bday,tbl_studentinfo.gradelevel
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.firstname LIKE '$whatsearch%' ORDER BY tbl_studentinfo.firstname ASC LIMIT ".$limit." OFFSET ".$off;
                        ;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.firstname LIKE '$whatsearch%'";
                     ...
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.bday ,tbl_studentinfo.gradelevel
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.firstname LIKE '$whatsearch%' ORDER BY tbl_studentinfo.firstname DESC LIMIT ".$limit." OFFSET ".$off;
                        ;
                  ...
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.bday,tbl_studentinfo.gradelevel
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$typeschool' ORDER BY tbl_studentinfo.firstname ASC LIMIT ".$limit." OFFSET ".$off;
                        ;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$typeschool'";
                     ...
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.bday ,tbl_studentinfo.gradelevel
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$typeschool' ORDER BY tbl_studentinfo.firstname DESC LIMIT ".$limit." OFFSET ".$off;
                        ;
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title"> List of College Current Recipients </h4>
                    <table class="table">
                      <thead>
                        <tr>
                           <th style="width:5%;">#</th>
                          ...
                          <th style="width:14%;">Year & Course</th>
                            ...
                            while($row = $result->fetch_assoc()){
                              ...
                              $application_no=$row['application_no'];
                               echo '<tr>';
                                ...
                                echo '</td>';
                                   echo '<td>';
                                echo $row['gradelevel']."/".$row['course'];
                                echo '</td>';
                                echo '<td>';
                                echo $row['barangay'];
                                echo '</td>';
                              ...
                              $sqla = "SELECT * FROM tbl_renew_year WHERE status='$status1' OR status='$status2'";
                               ...
                               $academic_id=$rowa['id'];
                                   ...
                                   if ($resulta->num_rows > 0){
                                     ...
                                     $sqlg = "SELECT * FROM tbl_renew WHERE academic_id='$academic_id' AND academic_year='$academic_year' AND application_no='$application_no'";
                                      ...
                                      $rowg = $resultg->fetch_assoc();
                                       ...
                                       // if ($resultg->num_rows > 0){
                                            echo '<button id="';
                                          echo $rowg['id'];
                                          echo '" type="button" class="btn btn-icons btn-rounded btn-primary" data-toggle="modal" data-target="#updateRenewal';
                                          echo $rowg['id'];
                                          echo '">
                                            <i class="fa fa-file-o" data-toggle="tooltip" data-placement="top" title="Click to view/approve renewal requirement!"></i>';
                                             echo '</button>&nbsp';
    ...
    //                             $sqly = "SELECT * FROM tbl_renew WHERE academic_id='$academic_id' AND academic_year='$academic_year' AND application_no='$application_no'";
    ...
    //                                     echo '<button id="';
    // echo $row['id'];
    //   echo '" type="button" class="btn btn-icons btn-rounded"
    //   style="background-color:#722ed1;" data-toggle="modal" data-target="#modalRenewal" onClick="setRenewal(this.id)">
    //     <i style="color:#ffffff;" class="fa fa-envelope" data-toggle="tooltip" data-placement="top" title="Click to notify scholars to submit renewal requirements!"></i>';
    //   echo '</button>';
    //                               }
                      ...
                      <?php
                        if($_SESSION['page']<=1){
                          echo '<button class="btn btn-warning" disabled>Previous</button>';
                           ...
                           echo '<a href="current_back.php" class="btn btn-warning" >Previous</a>';
                        }
                      ?>
                       <?php echo ($off+1)."-".$count.'/'.$total?>
                        ...
                        if($count>=$total){
                          echo '<button class="btn btn-primary" disabled>Next</button>';
                           ...
                           echo '<a href="current_next.php" class="btn btn-primary">Next</a>';
                        }
                      ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Grant Release</h5>
      ...
      <div class="modal-body">
         <div class="col-md-12">
          <div class="form-group">
            ...
            <select name="filter-assess" id="filter-assess" class="form-control">
           ...
           <div class="form-group">
            ...
            <input type="number" placeholder="Enter number of grant" id="grant" class="form-control" min="0">
          </div>
          <div class="form-group">
       ...
       $sqlg = "SELECT * FROM tbl_renew WHERE  academic_id='$academic_id' AND academic_year='$academic_year' AND application_no='$application_no'";
        ...
        if ($resultg->num_rows > 0){
           $rowg = $resultg->fetch_assoc();
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
              <form action="updateRenew.php" method="post">
                <div class="modal-header">';
 ...
 $status1="OPEN";
  ...
  if($order=="ASC"){
       ...
       $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no
        ...
        INNER JOIN tbl_studentinfo
        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$schooltype' ORDER BY tbl_studentinfo.firstname ASC LIMIT ".$limit." OFFSET ".$off;
                        ;
    ...
    $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no
        ...
        INNER JOIN tbl_studentinfo
        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$schooltype' ORDER BY tbl_studentinfo.firstname DESC LIMIT ".$limit." OFFSET ".$off;
                        ;
  }
    $result = $conn->query($sql);
   while($row = $result->fetch_assoc()){
 ...
 echo '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="updateGradeCurrent.php" method="post">
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <label >Grade for A.Y. ';
            ...
            $sqlc = "SELECT * FROM tbl_assesment WHERE id='$thisid'";
            $resultc = $conn->query($sqlc);
            $rowc = $resultc->fetch_assoc();
