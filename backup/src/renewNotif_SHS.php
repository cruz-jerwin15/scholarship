...
if(($_SESSION['studenttype']!="shscholar")||($_SESSION['pages']!="renewnotif-shscholar")){
 $_SESSION['studenttype']="shscholar";
  $_SESSION['search']="ALL";
  $_SESSION['pages']="renewnotif-shscholar";
  $_SESSION['whatsearch']="";
  $_SESSION['order']="ASC";
  $_SESSION['limit']=10;
  $_SESSION['offset']=1;
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Renewal Notification > Senior High Financial Assistance </h4>
     ...
     $academic_id=$rowa['id'];
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title"> List of Senior High Financial Assistance </h4>
                    <table class="table">
                      <thead>
                        <tr>
                          <th style="width:5%;">#</th>
