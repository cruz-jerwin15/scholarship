            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Senior High School Applicant</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                         <div class="form-group">
                            <label for="pbarangay">Barangay</label>
                             <div class="input-group">
                              <input type="text" name="pstreet" id="pstreet" class="form-control" placeholder="Street" value="<?php echo $p_barangay; ?>" disabled>
                            </div>
                          </div>
                      </div>
                      <div class="col-md-12"><hr></div>
                      ...
                      <div class="col-md-3">
                         <div class="form-group">
                            ...
                            <div class="input-group">
                              <input type="text" name="gross" id="gross" class="form-control" placeholder="Annual Gross" value="<?php echo $p_gross;?>" disabled>
                            </div>
                          </div>
                      </div>
                      <div class="col-md-3">
                      ...
                      <div class="col-md-3">
                         <div class="form-group">
                            <label for="schooladdress">Highest Year Attende</label>
                            <div class="input-group">
