...
if($_SESSION['usertype']!="superadmin"){
              ...
              echo 'alert("You cannot access this module.")';
              echo '</script>';
			echo '<script language="javascript">';
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Settings/Pin</h4>
                          ...
                          if ($result->num_rows > 0){
                              while($row = $result->fetch_assoc()){
                                ...
                                echo '<td>';
                                 echo '<button id="';
                                echo $row['id'];
                                echo '" type="button" class="btn btn-icons btn-rounded btn-success"  data-toggle="modal" data-target="#addUser">
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Get Pin</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-12">
            <p>Note: By clicking the submit button, you create a new pin number.</p>
