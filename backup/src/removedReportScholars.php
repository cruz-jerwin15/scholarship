...
if(($_SESSION['studenttype']!="fullscholar")||($_SESSION['pages']!="removescholarsrecipient-fullscholar")){



          $_SESSION['studenttype']="fullscholar";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="removescholarsrecipient-fullscholar";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
    ...
    <script>
      ...
      function getUsersApprove(id){
       ...
       function getAssessment(){
        window.open("reportRemovedScholars.php","_blank");
      }
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Reports > Removed Scholars & Recipients </h4>
              ...
              <div class="col-md-12"><hr></div>
               <form  action="getRemoveScholarReportSearch.php" method="post">
              <div class="col-md-12">
                <!-- <div class="page-header-toolbar"> -->
                  <div class="row">
                    <div class="col-md-3">
                          ...
                          <label for="housenumber">Filter</label>
                            <div class="input-group">
                              <select name="filter" id="filter" class="form-control">
                                ...
                                <option value="SCHOOL YEAR & SEMESTER">SCHOOL YEAR & SEMESTER</option>
            ...
            <div class="row">
               ...
               <?php
                ...
                if($filter=="ALL"){
                 if($order=="ASC"){
                      ...
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks,tbl_studentinfo.gradelevel,tbl_studentinfo.course
                        FROM tbl_admin
                        ...
                        WHERE (tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove') ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                          WHERE (tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')";
                     ...
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks,tbl_studentinfo.gradelevel,tbl_studentinfo.course
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE (tbl_remarks.process='$status' OR tbl_remarks.process='$status1') OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove') ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks,tbl_studentinfo.gradelevel,tbl_studentinfo.course
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_admin.username='$whatsearch' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                          WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_admin.username='$whatsearch'";
                      ...
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks,tbl_studentinfo.gradelevel,tbl_studentinfo.course
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_admin.username='$whatsearch' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks,tbl_studentinfo.gradelevel,tbl_studentinfo.course
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')   OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_studentinfo.lastname LIKE '$whatsearch%' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                          WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_studentinfo.lastname LIKE '$whatsearch%'";
                       ...
                       $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks,tbl_studentinfo.gradelevel,tbl_studentinfo.course
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')   OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_studentinfo.lastname LIKE '$whatsearch%' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                       $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks,tbl_studentinfo.gradelevel,tbl_studentinfo.course
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_studentinfo.firstname LIKE '$whatsearch%' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                          WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_studentinfo.firstname LIKE '$whatsearch%'";
                      ...
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks,tbl_studentinfo.gradelevel,tbl_studentinfo.course
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')   OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_studentinfo.firstname LIKE '$whatsearch%' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                     ...
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks,tbl_studentinfo.gradelevel,tbl_studentinfo.course
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_remarks.academic_id='$renewyear' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                          WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_remarks.academic_id='$renewyear'";
                     ...
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks,tbl_studentinfo.gradelevel,tbl_studentinfo.course
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_remarks.academic_id='$renewyear' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                     if(strlen($whatsearch)<=0){
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_remarks.scholars='$scholars'  ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                          WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_remarks.scholars='$scholars'";
                     }else{
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_remarks.scholars='$scholars' AND tbl_remarks.academic_id='$renew_id' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                          WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_remarks.scholars='$scholars' AND tbl_remarks.academic_id='$renew_id'";
                     }
                      ...
                      if(strlen($whatsearch)<=0){
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_remarks.scholars='$scholars'  ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status' OR tbl_remarks.process='$status1')  OR (tbl_remarks.process='$status2' AND tbl_remarks.remove='$remove')) AND tbl_remarks.scholars='$scholars' AND tbl_remarks.academic_id='$renew_id' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title"> <?php echo $renewyear;?>List of Removed Scholars & Recipients</h4>
                   <table class="table">
                      <thead>
                        <tr>
                          <th style="width:3%;">#</th>
                          ...
                          <th style="width:15%;">Year/Grade</th>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">Retrieve Removed Scholar/Recipient</h5>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                 <form action="retrieveOldScholars.php" method="post">
                      ...
                      <?php
                        if($_SESSION['page']<=1){
                          echo '<button class="btn btn-warning" disabled>Previous</button>';
                           ...
                           echo '<a href="scholarremovereport_back.php" class="btn btn-warning" >Previous</a>';
                        }
                      ?>
                       <?php echo ($off+1)."-".$count.'/'.$total?>
                        ...
                        if($count>=$total){
                          echo '<button class="btn btn-primary" disabled>Next</button>';
                           ...
                           echo '<a href="scholarremovereport_next.php" class="btn btn-primary">Next</a>';
                        }
                      ?>
