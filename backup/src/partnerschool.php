          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="index.php"> Home </a>
                       ...
                       <div style="min-height:650px;height:auto;"> 

                                <section id="service-block-main" class="section" style="  background-color: #F2EEEE;">
                      <!-- Container Starts -->
                      <div class="container-fluid page-body-wrapper full-page-wrapper">
        <div class="content-wrapper d-flex align-items-center auth  theme-one" style="min-height:650px;height:auto;">
          <div class="row w-100">
            <div class="col-lg-4 mx-auto" style="margin-top:75px;">
              <h2 class="text-center mb-4">Partner Schools</h2>
            
            </div>
             <div class="col-lg-12" style="width:90%;margin-left:2.5%;">
                <div class="row">
                    ...
                    $sql = "SELECT * FROM tbl_partnerschool ORDER BY school_name";
                          ...
                          if ($result->num_rows > 0){
                              while($row = $result->fetch_assoc()){
                                  echo '<div class="card col-md-4" style="width:30%;">
