...
<html lang="en">
  <head>
    ...
    <script>
      ...
      var blockid=0;
      function getUnBlockId(id){
        blockid=id;

      }
      function unBlockStudent(){
        var newid = blockid;
        window.open("ubBlockRecipient.php?id="+newid,"_self");
      }
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Blocked > SHS Recipients </h4>
              ...
              <div class="col-md-12"><hr></div>
               <form  action="getBlockSearch.php" method="post">
              <div class="col-md-12">
                <!-- <div class="page-header-toolbar"> -->
                  <div class="row">
                    <div class="col-md-3">
            ...
            <div class="row">
                ...
                if($filter=="ALL"){
                 if($order=="ASC"){
                      ...
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        WHERE ((tbl_remarks.process='$status') AND (tbl_remarks.remove='$remove' OR tbl_remarks.remove='$remove1')) ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                          WHERE ((tbl_remarks.process='$status') AND (tbl_remarks.remove='$remove' OR tbl_remarks.remove='$remove1'))";
                      ...
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status') AND (tbl_remarks.remove='$remove' OR tbl_remarks.remove='$remove1')) ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                     $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status') AND (tbl_remarks.remove='$remove' OR tbl_remarks.remove='$remove1')) AND tbl_admin.username ='$whatsearch' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                          WHERE ((tbl_remarks.process='$status') AND (tbl_remarks.remove='$remove' OR tbl_remarks.remove='$remove1')) AND tbl_admin.username='$whatsearch'";
                      ...
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status') AND (tbl_remarks.remove='$remove' OR tbl_remarks.remove='$remove1')) AND tbl_admin.username='$whatsearch' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                    $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status') AND (tbl_remarks.remove='$remove' OR tbl_remarks.remove='$remove1')) AND tbl_studentinfo.lastname LIKE '$whatsearch%' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                          WHERE ((tbl_remarks.process='$status') AND (tbl_remarks.remove='$remove' OR tbl_remarks.remove='$remove1')) AND tbl_studentinfo.lastname LIKE '$whatsearch%'";
                      ...
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status') AND (tbl_remarks.remove='$remove' OR tbl_remarks.remove='$remove1')) AND tbl_studentinfo.lastname LIKE '$whatsearch%' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status') AND (tbl_remarks.remove='$remove' OR tbl_remarks.remove='$remove1')) AND tbl_studentinfo.firstname LIKE '$whatsearch%' ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                       ...
                       $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        ...
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                          INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                          WHERE ((tbl_remarks.process='$status') AND (tbl_remarks.remove='$remove' OR tbl_remarks.remove='$remove1')) AND tbl_studentinfo.firstname LIKE '$whatsearch%'";
                       ...
                       $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_remarks.remarks
                        ...
                        INNER JOIN tbl_remarks
                        ON tbl_admin.id=tbl_remarks.user_id
                        WHERE ((tbl_remarks.process='$status') AND (tbl_remarks.remove='$remove' OR tbl_remarks.remove='$remove1')) AND tbl_studentinfo.firstname LIKE '$whatsearch%' ORDER BY tbl_admin.id DESC LIMIT ".$limit." OFFSET ".$off;
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title"> List of Blocked SHS Recipients</h4>
                              ...
                              $application_no=$row['application_no'];
                               echo '<tr>';
                                ...
                                echo '<td>';
                                 echo '<button id="';
                                            echo $row['id'];
                                            echo '" onClick="getUnBlockId(this.id)" type="button" class="btn btn-icons btn-rounded btn-success" data-toggle="modal" data-target="#modalUnBlock">';
                                            echo ' <i class="fa fa-eject" data-toggle="tooltip" data-placement="top" title="Click to ublock this former recipient!"></i>';
                                             echo '</button>&nbsp';
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">Retrieve Blocked Applicant/Scholar/Recipient</h5>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                 <form action="retrieveBlock.php" method="post">
                                <div class="modal-body">

                                   <div class="col-md-12">
                                      <p>
                                        Note:<span style="color:red;">You need to enter pin code to change blocked status.</span>
                                      </p>
                                   </div>
                                   <div class="col-md-12">
                                  <div class="form-group">
                      ...
                      <?php
                        if($_SESSION['page']<=1){
                          echo '<button class="btn btn-warning" disabled>Previous</button>';
                           ...
                           echo '<a href="blockReport_back.php" class="btn btn-warning" >Previous</a>';
                        }
                      ?>
                       <?php echo ($off+1)."-".$count.'/'.$total?>
                        ...
                        if($count>=$total){
                          echo '<button class="btn btn-primary" disabled>Next</button>';
                           ...
                           echo '<a href="blockReport_next.php" class="btn btn-primary">Next</a>';
                        }
                      ?>
...
<div class="modal fade" id="modalUnBlock" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Unblock Recipients</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
         ...
         <div class="col-md-12">
            <p>
              Note:<span style="color:red;">Do you want to un-block this student?</span>
            </p>
         </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" onClick="unBlockStudent()" class="btn btn-primary">Unblock</button>
      </div>
    </div>
