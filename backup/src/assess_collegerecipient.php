...
if(($_SESSION['studenttype']!="collegerecipient")||($_SESSION['pages']!="assesscurrent-collegerecipient")){

  if($_SESSION['pages']!="assessnotif-collegerecipient"){

          $_SESSION['studenttype']="collegerecipient";
        $_SESSION['search']="ALL";
        $_SESSION['pages']="assesscurrent-collegerecipient";
        $_SESSION['whatsearch']="";
        $_SESSION['order']="ASC";
        $_SESSION['limit']=10;
        $_SESSION['offset']=1;
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Assessment Recipients >College Educational Assistance (<?php echo $category?>)</h4>
