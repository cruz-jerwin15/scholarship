            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Report Scholars & Recipients > Assessment Requirements </h4>
              ...
              <div class="col-md-12"><hr></div>
               <form  action="getAssessmentRequirementReport.php" method="post">
              <div class="col-md-12">
                ...
                if($filter=="ALL"){
                      if($_SESSION['whatsearch']=="ALL"){
                              if($order=="ASC"){
                                   ...
                                   $sql = "SELECT tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.middlename,tbl_studentinfo.lastname,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_assess_req_label.school_id,tbl_assess_req_label.registration_form,tbl_assess_req_label.school_clearance,tbl_assess_req_label.gradereport
                                      FROM tbl_admin 
                                      ...
                                      JOIN tbl_assess_req_label
                                       ON tbl_admin.academic_year=tbl_assess_req_label.academic_year AND tbl_admin.application_no=tbl_assess_req_label.application_no
                            ...
                            if($order=="ASC"){
                                ...
                                $acad = $row2['id'];
                                     $sql = "SELECT tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.middlename,tbl_studentinfo.lastname,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_assess_req_label.school_id,tbl_assess_req_label.registration_form,tbl_assess_req_label.school_clearance,tbl_assess_req_label.gradereport
                                      ...
                                      JOIN tbl_assess_req_label
                                       ON tbl_admin.academic_year=tbl_assess_req_label.academic_year AND tbl_admin.application_no=tbl_assess_req_label.application_no
                                       WHERE tbl_assess_req_label.academic_id='$acad'
                                       ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                            ...
                            if($order=="ASC"){
                                ...
                                $acad = $row2['id'];
                                   $sql = "SELECT tbl_admin.username,tbl_studentinfo.firstname,tbl_studentinfo.middlename,tbl_studentinfo.lastname,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_assess_req_label.school_id,tbl_assess_req_label.registration_form,tbl_assess_req_label.school_clearance,tbl_assess_req_label.gradereport
                                      ...
                                      JOIN tbl_assess_req_label
                                       ON tbl_admin.academic_year=tbl_assess_req_label.academic_year AND tbl_admin.application_no=tbl_assess_req_label.application_no
                                       WHERE tbl_assess_req_label.academic_id='$acad' AND tbl_admin.typescholar='$scholarship'
                                       ORDER BY tbl_admin.id ASC LIMIT ".$limit." OFFSET ".$off;
                      ...
                      <thead>
                        <tr>
                          ...
                          <th style="width:15%;">School ID</th>
                           <th style="width:15%;">Registration Form</th>
                           <th style="width:15%;">School Clearance</th>
                           <th style="width:15%;">Grade Reports</th>
                      ...
                      <tbody style="font-size:9px;">
                          ...
                          $count=$off;
                            ...
                            while($row = $result->fetch_assoc()){
                                          ...
                                          if(strlen($row['school_clearance'])>0){
                                            if($row['school_clearance']=="NOT APPLICABLE"){
                                              echo $row['school_clearance'];
                                            }else{
                                              echo '<a class="btn btn-success" href="requirements/';
                                              echo $row['school_clearance'];
                                              echo '"><i class="fa fa-eye"></i>';
                                          ...
                                          if(strlen($row['gradereport'])>0){
                                            if($row['gradereport']=="NOT APPLICABLE"){
                                              echo $row['gradereport'];
                                            }else{
                                              echo '<a class="btn btn-success" href="requirements/';
                                              echo $row['gradereport'];
                                              echo '"><i class="fa fa-eye"></i>';
                      ...
                      <?php
                        if($_SESSION['page']<=1){
                          echo '<button class="btn btn-warning" disabled>Previous</button>';
                           ...
                           echo '<a href="reportassessrequirement_back.php" class="btn btn-warning" >Previous</a>';
                        }
                      ?>
                       <?php echo ($off+1)."-".$count.'/'.$total?>
                        ...
                        if($count>=$total){
                          echo '<button class="btn btn-primary" disabled>Next</button>';
                           ...
                           echo '<a href="reportassessrequirement_next.php" class="btn btn-primary">Next</a>';
                        }
                      ?>
