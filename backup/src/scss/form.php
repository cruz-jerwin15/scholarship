...
<?php
         if(isset($_POST["submit"])){
            ...
            // if ($form_type == "11" || $form_type == "12"){
            //   $category = "EA Senior High";
            // }
            // else if($form_type == "21" || $form_type == "22" || $form_type == "23" || $form_type == "24" || $form_type == "25" ){
            //   $category = "EA College";
            // }
            ...
            $sql = "INSERT INTO tbl_userinfo (FirstName,MiddleName,LastName,Age,Sex,DateOfBirth,PlaceOfBirth,Citizenship,Image,EmailAddress, fb_account, contactnumber, contactnumbertwo, Category, canview, batch, remarks, assessment, approve,requirements) 
            VALUES ('$fname','$mname','$lname','$age','$sex','$bday','$PlaceOfBirth','$Citizenship', '$Image','$EmailAddress', '$fb', '$contactnumber', '$contactnumbertwo', '$category', '0', '0', ' ', '0', '0', 'None')";
            ...
            $sql2 = "INSERT INTO tbl_school (user_id,YearCompleted,GWA,SchoolIntended,LastSchoolAttended,ExamRating,Course,Scholarship, SchoolYear) 
            VALUES ('$last_id','$HighestYearCompleted','$GWA','$SchoolIntended','$LastSchoolAttended','$ExamRating','$Courses','$Scholarship', '')";
            ...
            $sql5 = "INSERT INTO tbl_parents (user_id,FatherFirstName,FatherMiddleName,FatherLastName,MotherFirstName,MotherMiddleName,MotherLastName,FatherAge,MotherAge,FatherOccupation,MotherOccupation,TotalMembers,siblings,Income)
            VALUES ('$last_id', $FatherFirstName,$FatherMiddleName,$FatherLastName,$MotherFirstName,$MotherMiddleName,$MotherLastName,$FatherAge, $MotherAge, $FatherOccupation, $MotherOccupation,$NoFamilyMembers,$Siblings,$Income)";

            $sql6 = "INSERT INTO tbl_parentsaddress (user_id,StreetNumber,RoadName,Barangay,Town,Province)
            VALUES ('$last_id',$ParentStreetNumber,$ParentRoadName,'$ParentBarangay','$ParentTown','$ParentProvince')";
            ...
            if($sql_result){
              // $result = mysqli_query($conn, "SELECT max(id) as id FROM tbl_userinfo");
  ...
  <body id="page-top">
                              ...
                              <div class="list"></div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="form-group floating-label-form-group controls mb-0 pb-2" >
                                        ...
                                        <input class="form-control" type="text" name="firstname" id="firstname" class="form-control input-lg" placeholder="First Name*" required>
                                      </div>
                                      </div>
                                      </div>
                                      ...
                                      <div class="form-group floating-label-form-group controls mb-0 pb-2" >
                                        <label>Birthdate</label>
                                          <input type="date" name="birthdate" id="birthdate" class="form-control input-sm " onblur="getAge();">
                                        </div>
                                        </div>
                                  ...
                                  <select name="gender" class="form-control">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="form-group floating-label-form-group controls mb-0 pb-2" >
                                        <label> Place of Birth</label>
                                          <input type="text" name="PlaceOfBirth" id="placeob" class="form-control input-lg" placeholder="Place of Birth*" required>
                                        </div>
                                        </div>
                                      ...
                                      <div class="form-group floating-label-form-group controls mb-0 pb-2" >
                                        <label> Citizenship </label>
                                          <input type="text" name="Citizenship" id="citizenship" class="form-control input-lg" placeholder="Citizenship*" required>
                                        </div>
                                        </div>
                                      ...
                                      <label> Street Number </label>
                                          <input type="number" name="Street" id="housenum" class="form-control input-lg" placeholder="House Number" >
                                        </div>
                                        </div>
                                      ...
                                      <label> Roadname </label>
                                          <input type="text" name="RoadName" id="rname" class="form-control input-lg" placeholder="Road Name">
                                        </div>
                                        </div>
                                      ...
                                      <label> Barangay </label>
                                          <input type="text" name="Barangay" id="barangay" class="form-control input-lg" placeholder="Barangay*" required>
                                        </div>
                                        </div>
                                      ...
                                      <div class="form-group floating-label-form-group controls mb-0 pb-2" >
                                      <label> Town </label>
                                          <input type="text" name="town"  id="town" class="form-control input-lg" placeholder="Town*" required>
                                        </div>
                                        </div>
                                      ...
                                      <label> Province </label>
                                          <input type="text" name="province" id="province"  class="form-control input-lg" placeholder="Province*" required>
                                        </div>
                                        </div>
                                     ...
                                     <div class="row">
                                      ...
                                      <label> Last School Attended </label>
                                          <input type="text" name="LastSchoolAttended" id="lastschoolattended" class="form-control input-lg" placeholder="Last School Attended*" required>
                                        </div>
                                        </div>
                                    ...
                                    <!-- START -->
                                     <div class="row">
                                      ...
                                      <label> School Street Number </label>
                                          <input type="number" name="SchoolStreetNumber" id="schoolstreetnum" class="form-control input-lg" placeholder="School's Street Number" >
                                        </div>
                                        </div>
                                      ...
                                      <label> School's Road Name </label>
                                          <input type="text" name="SchoolRoadName" id="schoolrname" class="form-control input-lg" placeholder="School's Road Name">
                                        </div>
                                        </div>
                                      ...
                                      <label> School's Barangay </label>
                                          <input type="text" name="SchoolBarangay" id="schoolbarangay" class="form-control input-lg" placeholder="School's Barangay">
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <label> School's Town </label>
                                          <input type="text" name="SchoolTown" id="schooltown" class="form-control input-lg" placeholder="School's Town*" required>
                                        </div>
                                        </div>
                                      ...
                                      <label> School's Province </label>
                                          <input type="text" name="SchoolProvince" id="schoolprov" class="form-control input-lg" placeholder="School's Province*" required>
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <label> Highest Year Attended </label>
                                          <input type="text" name="HighestYearAttended" id="highyrattended" class="form-control input-lg" placeholder="Highest year Attended(sample: 4th year)*" required>
                                        </div>
                                        </div>
                                      ...
                                      <label> weighted average </label>
                                          <input type="number" id="genave" name="WeightedAverage" max="100" min="0" class="form-control input-lg" placeholder="Gen. Weighted Ave*" required>
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="form-group floating-label-form-group controls mb-0 pb-2" >
                                      <label> Email </label>
                                          <input type="email" id="emailadd" name="Email" class="form-control input-lg" placeholder="Email Address">
                                        </div>
                                      </div>
                                      </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <label> Fb Account </label>
                                          <input type="text" name="fb_account" id="fbaccount" class="form-control input-lg" placeholder="FB account">
                                        </div>
                                      </div>
                                      </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <label>Contact Number </label>
                                          <input type="ContactNumber" id="contactnumber" name="ContactNumber" class="form-control input-lg" placeholder="Contact Number">
                                        </div>
                                      </div>
                                      </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <label> Second Contact Number </label>
                                          <input type="ContactNumber" id="seecondcontactnumber" name="ContactNumbertwo" class="form-control input-lg" placeholder="Second Contact Number">
                                        </div>
                                      </div>
                                      </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <label> Entrance Exam Rating </label>
                                          <input type="text" name="EntranceExamRating" id="entranceexamrate" class="form-control input-lg" placeholder="Entrance Exam Rating*" required>
                                        </div>
                                        </div>
                                      ...
                                      <label> Course Intended to take </label>
                                          <input type="text" name="Course" id="courseintendedtotake" class="form-control input-lg" placeholder="Course intended to take*" required>
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                      ...
                                      <label> Father's First Name </label>
                                        <input type="text" id="fatherfname" name="FatherFirstName" class="form-control input-lg" placeholder="Father's First Name" >
                                      </div>
                                      </div>
                                      ...
                                      <label> Father's Middle Name </label>
                                        <input type="text" id="fathermname" name="FatherMiddleName" class="form-control input-lg" placeholder="Father's Middle Name" >
                                      </div>
                                      </div>
                                     ...
                                     <div class="control-group" style="background-color:none;">
                                      ...
                                      <label> Father's Last Name </label>
                                        <input type="text"id="fatherlname"  name="FatherLastName" class="form-control input-lg" placeholder="Father's Last Name" >
                                      </div>
                                      </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <label> Father's Age </label>
                                          <input type="number" id="fatherage" name="FatherAge"  class="form-control input-lg" placeholder="Father Age">
                                        </div>
                                        </div>
                                      ...
                                      <label> Father's Occupation </label>
                                          <input type="text" id="fatheroccupation" name="FatherOccupation" class="form-control input-lg" placeholder="Father Occupation" >
                                        </div>
                                        </div>
                                     ...
                                     <div class="row">
                                      ...
                                      <label> Mother's First Name </label>
                                        <input type="text" id="motherfname" name="MotherFirstName" class="form-control input-lg" placeholder="Mother's First Name" >
                                      </div>
                                      </div>
                                      ...
                                      <label> Mother's Middle Name </label>
                                        <input type="text" id="mothermname" name="MotherMiddleName" class="form-control input-lg" placeholder="Mother's Middle Name" >
                                      </div>
                                      </div>
                                      ...
                                      <label> Mother's Last Name </label>
                                        <input type="text" id="motherlname" name="MotherLastName" class="form-control input-lg" placeholder="Mother's Last Name" >
                                      </div>
                                      </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <label> Mother's Age </label>
                                          <input type="number" id="motherage" name="MotherAge"  class="form-control input-lg" placeholder="Mother Age">
                                        </div>
                                        </div>
                                      ...
                                      <label> Mother's Occupation </label>
                                          <input type="text" id="motheroccupation" name="MotherOccupation" class="form-control input-lg" placeholder="Mother Occupation">
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <label> Parent's Street Number</label>
                                          <input type="number" id="parentstreetnumber" name="ParentStreetNumber" class="form-control input-lg" placeholder="Parent's StreetNumber">
                                        </div>
                                        </div>
                                      ...
                                      <label> Parent's Road Name</label>
                                          <input type="text" id="parentrname" name="ParentRoadName" class="form-control input-lg" placeholder="Parent's Road Name">
                                        </div>
                                        </div>
                                      ...
                                      <label> Parent's Barangay</label>
                                          <input type="text" id="parentbarangay" name="ParentBarangay" class="form-control input-lg" placeholder="Parent's Barangay*" required>
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <label> Parent's Town</label>
                                          <input type="text" id="parenttownr" name="ParentTown" class="form-control input-lg" placeholder="Parent's Town*" required>
                                        </div>
                                        </div>
                                      ...
                                      <label> Parent's Province</label>
                                          <input type="text" id="parentprovince" name="ParentProvince" class="form-control input-lg" placeholder="Parent's Province*" required>
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <label> Number of Family Memebers</label>
                                          <input type="number" id="nofammembers" name="NoFamilyMembers" class="form-control input-lg" placeholder="No. of Family Members*" required>
                                        </div>
                                        </div>
                                      ...
                                      <label> Number of Siblings</label>
                                          <input type="number" id="nosibs" name="sib" class="form-control input-lg" placeholder="No. of Siblings*" required>
                                        </div>
                                        </div>
                                      ...
                                      <label> Total Gross Income per year</label>
                                          <input type="number" id="totalgrossincome" name="Income" class="form-control input-lg" placeholder="Total Gross Income per year*" required>
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <label> Sibling's First Name</label>
                                                    <input type="text" id="sibfname" class="another" name="sib_fname[]" class="form-control input-lg" placeholder="Sibling's First Name" >
                                                  </div>
                                                  </div>
                                      ...
                                      <label> Sibling's Middle Name</label>
                                                    <input type="text" class="sibmnameanother" id="sibmname" name="sib_mname[]" class="form-control input-lg" placeholder="Sibling's Middle Name" >
                                                  </div>
                                                  </div>
                                      ...
                                      <label> Sibling's Last Name</label>
                                                    <input type="text" id="siblname" class="siblnameanother" name="sib_lname[]" class="form-control input-lg" placeholder="Sibling's Last Name" >
                                                  </div>
                                                  </div>
                                      ...
                                      <label> Educational Assistance</label>
                                                    <input type="text" id="sibeducassistance" class="sibeducanother" name="sib_educ_assist[]" class="form-control input-lg" placeholder="Educational Assistance" >
                                                  </div>
                                                  </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 mb-5 mb-lg-0">
            ...
            <p class="lead mb-0">
                Read the requirements above .   Print the Application Form for you 
            to fill up at home and kindly bring it to our office. 
            </p>
          </div>
          ...
          <div class="col-md-4 mb-5 mb-lg-0">
            ...
            <p class="lead mb-0">
               <a href="loginform.php" style="text-decoration:none;"> 
                   Log In </a> | EPS Scholarship and Youth Development Office
            </p>
          </div>
          ...
          <div class="col-md-4">
            <h4 class="text-uppercase mb-4"> About EPS </h4>
            <p class="lead mb-0"><small>
            
              EPS Scholarship and Youth Development is a competitive scholarship program 
                that provides funding for qualified students in Sto. Tomas. 
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container">
        <small>Copyright &copy; Youth Development Office 2018</small>
      </div>
    </div>
...
<div class="form-group floating-label-form-group controls mb-0 pb-2" >
<label> Course Intended to take </label>
 <input type="text" name="Course" id="cit" class="form-control input-lg" placeholder="Course intended to take*" required disabled>
</div>
</div>
    ...
    $(this).attr('id',newID);
        ...
        $('#viewbtn').click(function(){
          ...
          $('#view :input').attr('disabled', true);
                                    ...
                                    var selected = $('#gendermf option:selected').text();
