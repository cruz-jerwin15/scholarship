                                      ...
                                      while($rowa = $resulta->fetch_assoc()){
                                        if($informed==$rowa['legend']){
                                          ...
                                          echo '</option>';
                                            ...
                                            <div class="col-md-12">
                                               <div class="form-group">
                                                <label>Please add the name of officials who informed you or If your answer is Others, please enter how you are informed <span style="color:red;">*</span></label>
                                                <input type="text" name="nameofficial"
                                                id="nameofficial"
                                                placeholder="Enter name of officials/Enter how you are informed"
