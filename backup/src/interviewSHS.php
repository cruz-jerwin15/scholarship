...
if(($_SESSION['studenttype']!="shscholar")||($_SESSION['pages']!="interview-shscholar")){
 $_SESSION['studenttype']="shscholar";
  $_SESSION['search']="ALL";
  $_SESSION['pages']="interview-shscholar";
  $_SESSION['whatsearch']="";
  $_SESSION['order']="ASC";
  $_SESSION['limit']=10;
  $_SESSION['offset']=1;
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">For Interview > SHS Educational Assistance </h4>
            ...
            <div class="row">
              <!-- Tabe here -->
               <?php
                ...
                if($filter=="ALL"){
                  if($order=="ASC"){
                      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gradelevel,tbl_studentinfo.phone  
                        FROM tbl_admin 
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                         ...
                         <div class="col-md-10">
                           <h4 class="card-title"> List of SHS Educational Assistance Applicants</h4>
                      </div>
                      <?php
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label >Interview Score. 1(Lowest) - 10(Highest)</label>
                <input type="number" min="0" max="10" name="interview_score" step=".01" class="form-control" placeholder="Interview Score" value="" required="true">
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
