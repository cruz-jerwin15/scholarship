    ...
    if(isset($_GET['form_type'])){
      ...
      switch ($form_type) {
        case '11':
          ...
          $form_level = '(Senior High - Grade 11 and 12)';
          break;

        case '1':
          $form_title = 'College - Full Scholarship';
          $form_level = '(College Only)';
          break;
        ...
        case '25':
          ...
          break;
        case '3':
          $form_title = 'FULL SCHOLARSHIP PROGRAM';
          $form_level = '(College)';
                ...
                <form action="dbregister.php" method="POST">
                  ...
                  <select class="form-control" name="usertype">
                    <?php
                      $ids = $_GET['form_type'];
                      if($ids==1){
                         echo '<option value="fullscholar" selected="selected">College Full Scholarship</option>';
                      }else  if($ids==11){

                         echo '<option value="shscholar" selected="selected">Senior High School</option>
                        ';
                      }else  if($ids==3){

                         echo '
                        <option value="collegerecipient" selected="selected">College Financial Assistance</option>';
                      }else {
