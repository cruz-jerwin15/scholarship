...
if (($_SESSION['studenttype'] != "collegerecipient") || ($_SESSION['pages'] != "assessment-collegerecipient")) {
  $_SESSION['studenttype'] = "collegerecipient";
  $_SESSION['search'] = "ALL";
  $_SESSION['pages'] = "assessment-collegerecipient";
  $_SESSION['whatsearch'] = "";
  $_SESSION['order'] = "ASC";
  $_SESSION['limit'] = 10;
  $_SESSION['offset'] = 1;
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
          ...
          <div class="row page-title-header">
            <div class="col-12">
              <div class="page-header">
                <h4 class="page-title">For Assessment > College Educational Assistance (<?php echo $category ?>)</h4>
        ...
        <div class="row">
          ...
          if ($filter == "ALL") {
            if ($order == "ASC") {
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.years_residency,tbl_studentinfo.bday,tbl_studentinfo.school
                        FROM tbl_admin
                        ...
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$cat' ORDER BY tbl_admin.applicant_number ASC LIMIT " . $limit . " OFFSET " . $off;;
              ...
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.years_residency,tbl_studentinfo.bday,tbl_studentinfo.school
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$cat' ORDER BY tbl_admin.applicant_number DESC LIMIT " . $limit . " OFFSET " . $off;;
            ...
            if ($order == "ASC") {
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.years_residency,tbl_studentinfo.bday,tbl_studentinfo.school
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$cat' AND tbl_studentinfo.barangay LIKE '$whatsearch%' ORDER BY tbl_studentinfo.barangay ASC LIMIT " . $limit . " OFFSET " . $off;;

              $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        FROM tbl_admin
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$cat' AND tbl_studentinfo.barangay LIKE '$whatsearch%'";
            } else {
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.years_residency,tbl_studentinfo.bday,tbl_studentinfo.school
                        FROM tbl_admin
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$cat' AND tbl_studentinfo.barangay LIKE '$whatsearch%' ORDER BY tbl_studentinfo.barangay DESC LIMIT " . $limit . " OFFSET " . $off;;
            ...
            if ($order == "ASC") {
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.years_residency,tbl_studentinfo.bday,tbl_studentinfo.school
                        ...
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$cat' AND tbl_studentinfo.schooltype='$typeschool' ORDER BY tbl_studentinfo.lastname ASC LIMIT " . $limit . " OFFSET " . $off;;

              $sql1 = "SELECT COUNT(tbl_admin.id) as total
                        FROM tbl_admin
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$cat' AND tbl_studentinfo.schooltype='$typeschool'";
            } else {
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.years_residency,tbl_studentinfo.bday,tbl_studentinfo.school
                        FROM tbl_admin
                        INNER JOIN tbl_studentinfo
                        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.schooltype='$cat' AND tbl_studentinfo.schooltype='$typeschool' ORDER BY tbl_studentinfo.lastname DESC LIMIT " . $limit . " OFFSET " . $off;;
            ...
            if ($order == "ASC") {
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.years_residency,tbl_studentinfo.bday,tbl_studentinfo.school
                        ...
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' ORDER BY tbl_finalscore.score ASC LIMIT " . $limit . " OFFSET " . $off;;
              ...
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.gwa,tbl_studentinfo.years_residency,tbl_studentinfo.bday,tbl_studentinfo.school
                        ...
                        INNER JOIN tbl_finalscore
                        ON tbl_admin.academic_year=tbl_finalscore.academic_year AND tbl_admin.application_no=tbl_finalscore.application_no
                        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_studentinfo.schooltype='$cat' AND tbl_admin.typescholar='$scholar' ORDER BY tbl_finalscore.score DESC LIMIT " . $limit . " OFFSET " . $off;;
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        echo '<th style="width:16%;">Name</th>';
                        echo '<th style="width:13%;">School</th>';
                        echo '<th style="width:12%;">Barangay</th>';
                        echo '<th style="width:10%;">GWA</th>';
                        echo '<th style="width:10%;">Total Points</th>';
                        echo '<th style="width:25%;"><center>Action</center></th>';
