...
if (($_SESSION['studenttype'] != "shscholar") || ($_SESSION['pages'] != "new-shscholar")) {
  $_SESSION['studenttype'] = "shscholar";
  $_SESSION['search'] = "ALL";
  $_SESSION['pages'] = "new-shscholar";
  $_SESSION['whatsearch'] = "";
  $_SESSION['order'] = "ASC";
  $_SESSION['limit'] = 10;
  $_SESSION['offset'] = 1;
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
          ...
          <div class="row page-title-header">
            <div class="col-12">
              <div class="page-header">
                <h4 class="page-title">New Applicant >SHS Educational Assistance </h4>
        ...
        <div class="row">
          ...
          if ($filter == "ALL") {
            if ($order == "ASC") {
              $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no,tbl_admin.username, tbl_studentinfo.firstname,tbl_studentinfo.lastname,tbl_studentinfo.middlename,tbl_studentinfo.barangay,tbl_studentinfo.phone,tbl_studentinfo.school,tbl_studentinfo.course,tbl_studentinfo.gradelevel
                        FROM tbl_admin
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <h4 class="card-title"> List of Senior High School Applicants </h4>
                  </div>
                  <?php
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th style="width:10%;">School/Track</th>
  ...
  <div class="modal-dialog" role="document">
    ...
    if ($order == "ASC") {
      ...
      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no
        ...
        INNER JOIN tbl_studentinfo
        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.gradelevel='$gradelevels' ORDER BY tbl_studentinfo.firstname ASC LIMIT " . $limit . " OFFSET " . $off;;
    } else {
      $sql = "SELECT tbl_admin.id,tbl_admin.academic_year,tbl_admin.application_no
        FROM tbl_admin
        INNER JOIN tbl_studentinfo
        ON tbl_admin.academic_year=tbl_studentinfo.academic_year AND tbl_admin.application_no=tbl_studentinfo.application_no
        WHERE tbl_admin.status='$status' AND tbl_admin.usertype='$usertype' AND tbl_admin.typescholar='$scholar' AND tbl_studentinfo.gradelevel='$gradelevels' ORDER BY tbl_studentinfo.firstname DESC LIMIT " . $limit . " OFFSET " . $off;;
    }
    $result = $conn->query($sql);
    while ($row = $result->fetch_assoc()) {
      $userids = $row['id'];
