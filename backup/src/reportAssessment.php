      ...
      function getUsersApprove(id){
       ...
       function getDetailed(){
        ...
        if(numspacing.length<=0){
         ...
         window.open("reportDetailedResult.php?spacing="+numspacing,"_self");
      }
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Reports > Assessment </h4>
              ...
              <div class="col-md-12"><hr></div>
               <form  action="getAssessmentReport.php" method="post">
              <div class="col-md-12">
                <!-- <div class="page-header-toolbar"> -->
                  <div class="row">
                    <div class="col-md-3">
            ...
            <div class="row">
              <!-- Tabe here -->
               <?php
                ...
                if($filter=="ALL"){
                  if($order=="ASC"){
                    $sql ="SELECT * FROM tbl_remarks WHERE remove='$remove' AND process='$process' ORDER BY user_id ASC LIMIT ".$limit." OFFSET ".$off;

                    $sql1 ="SELECT COUNT(user_id) as total FROM tbl_remarks WHERE remove='$remove' AND process='$process'"; 
                  }else{
                    $sql ="SELECT * FROM tbl_remarks WHERE remove='$remove' AND process='$process' ORDER BY user_id DESC LIMIT ".$limit." OFFSET ".$off;

                    $sql1 ="SELECT COUNT(user_id) as total FROM tbl_remarks WHERE remove='$remove' AND process='$process'";  
                  }
              }else if($filter=="ACADEMIC YEAR"){
                  if($order=="ASC"){
                     $sql = "SELECT tbl_remarks.user_id
                        FROM tbl_remarks 
                        INNER JOIN tbl_academic 
                        ON tbl_academic.id=tbl_remarks.academic_id
                        WHERE tbl_academic.academic_year LIKE '$whatsearch%' AND tbl_remarks.remove='$remove' AND process='$process' ORDER BY tbl_remarks.user_id ASC LIMIT ".$limit." OFFSET ".$off;
                   
                   $sql1 = "SELECT COUNT(tbl_remarks.user_id) as total
                        FROM tbl_remarks 
                        INNER JOIN tbl_academic 
                        ON tbl_academic.id=tbl_remarks.academic_id
                        WHERE tbl_academic.academic_year LIKE '$whatsearch%' AND tbl_remarks.remove='$remove' AND process='$process'";
                  }else{
                     $sql = "SELECT tbl_remarks.user_id
                        FROM tbl_remarks 
                        INNER JOIN tbl_academic 
                        ON tbl_academic.id=tbl_remarks.academic_id
                        WHERE tbl_academic.academic_year LIKE '$whatsearch%' AND tbl_remarks.remove='$remove' AND process='$process' ORDER BY tbl_remarks.user_id DESC LIMIT ".$limit." OFFSET ".$off;
                  ...
                  if($order=="ASC"){
                     $sql = "SELECT tbl_remarks.user_id
                        ...
                        INNER JOIN tbl_academic 
                        ON tbl_academic.id=tbl_remarks.academic_id
                        WHERE tbl_academic.academic_year LIKE '$whatsearch%' AND tbl_remarks.scholars='$scholarship' AND tbl_remarks.remove='$remove' AND process='$process' ORDER BY tbl_remarks.user_id ASC LIMIT ".$limit." OFFSET ".$off;
                   
                   $sql1 = "SELECT COUNT(tbl_remarks.user_id) as total
                        FROM tbl_remarks 
                        INNER JOIN tbl_academic 
                        ON tbl_academic.id=tbl_remarks.academic_id
                        WHERE tbl_academic.academic_year LIKE '$whatsearch%' AND process='$process' AND tbl_remarks.scholars='$scholarship' AND tbl_remarks.remove='$remove'";
                  }else{
                        $sql = "SELECT tbl_remarks.user_id
                        FROM tbl_remarks 
                        INNER JOIN tbl_academic 
                        ON tbl_academic.id=tbl_remarks.academic_id
                        WHERE tbl_academic.academic_year LIKE '$whatsearch%' AND tbl_remarks.scholars='$scholarship' AND tbl_remarks.remove='$remove' AND process='$process' ORDER BY tbl_remarks.user_id DESC LIMIT ".$limit." OFFSET ".$off;
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title"> List of Assessment Full Scholars and Recipients</h4>
                    <table class="table">
                      <thead>
                        <tr>
                          <th style="width:5%;">#</th>
                      ...
                      <?php
                        if($_SESSION['page']<=1){
                          echo '<button class="btn btn-warning" disabled>Previous</button>';
                           ...
                           echo '<a href="reportsassessment_back.php" class="btn btn-warning" >Previous</a>';
                        }
                      ?>
                       <?php echo ($off+1)."-".$count.'/'.$total?>
                        ...
                        if($count>=$total){
                          echo '<button class="btn btn-primary" disabled>Next</button>';
                           ...
                           echo '<a href="reportsassessment_next.php" class="btn btn-primary">Next</a>';
                        }
                      ?>
