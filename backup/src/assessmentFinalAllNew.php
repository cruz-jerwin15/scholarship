...
echo "<h4>Please wait... Currently processing total score.</h4>";
...
$torange=$_GET['totalstudent'];
   ...
   $pdf->SetFont('Times','',$header_font);
    ...
    if(($informed=="Mayor")||($informed=="Vice Mayor")||($informed=="City Councilor")){
      ...
      //total_other
      $totalother = $totalother+$informed_points;
    ...
    if($informed_points==0){
      ...
      //total_other
      $totalother = $totalother+$age_points;
    }
    ...
    if($informed_points==0){
      ...
      //total_other
      $totalother = $totalother+$working_student_points;
    }
    ...
    if($informed_points==0){
      ...
      //total_other
      $totalother = $totalother+$self_support_points;
    }
    ...
    if($informed_points==0){
      $totalscore=$totalscore+$pwd_student_points;
        //total_other
      $totalother = $totalother+$pwd_student_points;
    }
   ...
   $sql7 = "SELECT * FROM tbl_guardianinfo
    ...
    $pdf->SetFont('Times','',$content_font);
      ...
      $totalscore=$totalscore+$pwd_points;
        //total_other
      $totalother = $totalother+$pwd_points;
    }
    ...
    if($informed_points==0){
      $totalscore=$totalscore+$single_parent_points;
        //total_other
      $totalother = $totalother+$single_parent_points;
    }
      ...
      $totalscore=$totalscore+$parent_separated_points;
        //total_other
      $totalother = $totalother+$parent_separated_points;
    }
      ...
      $totalscore=$totalscore+$parent_deceased_points;
        //total_other
      $totalother = $totalother+$parents_deceased_points;
      }
      ...
      $totalscore=$totalscore+$parents_deceased_points;
        //total_other
      $totalother = $totalother+$parent_deceased_points;
      }
...
// End new
    ...
    if($result12->num_rows > 0){
        $st1 = "DRAFT";
        $sql14 = "SELECT COUNT(*) as items FROM tbl_answer_student WHERE exam_id='$exam_id' AND user_id='$userid' AND status<>'$st1'";
    ...
    if(($_SESSION['usertype']=="admin")||($_SESSION['usertype']=="superadmin")){
        if(($scholartype=="collegerecipient")||($scholartype=="shscholar")){
              ...
              //$totalscore=$totalscore+$committee_points;
                $sqlz = "SELECT * FROM tbl_finalscore WHERE academic_year='$academic_year' AND application_no='$application_no' AND academic_id='$academic_id'";
        $resultz = $conn->query($sqlz);
        $rowz = $resultz->fetch_assoc();
        ...
        if ($resultz->num_rows <= 0){
          ...
          $insert1= "UPDATE tbl_finalscore SET score='$totalscore' WHERE academic_year='$academic_year' AND application_no='$application_no'";
         $conn->query($insert1);
        }
//college recipient
         if(($scholartype=="collegerecipient")||($scholartype=="shscholar")){
           $sqlcollege = "SELECT * FROM tbl_college_grade WHERE academic_year='$academic_year' AND application_no='$application_no' AND academic_id='$academic_id'";
            $resultcollege = $conn->query($sqlcollege);
           if ($resultcollege->num_rows <= 0){
            $insert1= "INSERT INTO tbl_college_grade
                         (academic_id,
                         academic_year,
                         application_no,
                         applicant_number,
             ...
             $insert1= "UPDATE tbl_college_grade SET academic_id='$academic_id', grade='$total_grade',typescholar='$scholartype',income='$total_income',residency='$total_residency', others='$totalother',totalscore='$totalscore',applicant_number='$applicant_number' WHERE academic_year='$academic_year' AND application_no='$application_no'";
            $conn->query($insert1);
           }
        }else{


          $sqlcollege = "SELECT * FROM tbl_scholar_grade WHERE academic_year='$academic_year' AND application_no='$application_no' AND academic_id='$academic_id'";
            $resultcollege = $conn->query($sqlcollege);
           if ($resultcollege->num_rows <= 0){
            $insert1= "INSERT INTO tbl_scholar_grade
                         (academic_id,
                         academic_year,
                         application_no,
                         applicant_number,
             ...
             $insert1= "UPDATE tbl_scholar_grade SET academic_id='$academic_id', grade='$total_grade',typescholar='$scholartype',income='$total_income',residency='$total_residency',exam='$examgrade', others='$totalother',totalscore='$totalscore',applicant_number='$applicant_number' WHERE academic_year='$academic_year' AND application_no='$application_no'";
            $conn->query($insert1);
           }
        }
        ...
        $sqlcollege = "SELECT * FROM tbl_siblingsinfo WHERE academic_year='$academic_year' AND application_no='$application_no' AND help='YES'";
        $resultcollege = $conn->query($sqlcollege);
       if ($resultcollege->num_rows > 0){
