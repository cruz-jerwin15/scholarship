              ...
              <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <label >Email</label>
                        <input type="email" name="emails" class="form-control" placeholder="Email" required="true"
                        value="<?php echo $email?>"
                        disabled>
                         <input type="hidden" name="email" class="form-control" placeholder="Email" required="true"
                        value="<?php echo $email?>"
                        >
                    </div>
                  </div>
