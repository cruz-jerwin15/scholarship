    ...
    <script>
      ...
      function getUsersApprove(id){
       ...
       function getDetailed(){
        ...
        var filters = e.value;
         window.open("currentReportsOfficial.php?spacing="+numspacing+"&filter="+filters,"_self");
      }
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Report Scholars & Recipients > Official Result </h4>
              ...
              <div class="col-md-8 ">
                <div class="page-header-toolbar">
                     ...
                     <button type="button" class="btn btn-dark btn-fw" data-toggle="modal" data-target="#modalDetailed" >Download Official Result</button>
                  &nbsp
              ...
              <div class="col-md-12"><hr></div>
               <form  action="getOfficialCurrentReport.php" method="post">
              <div class="col-md-12">
                <!-- <div class="page-header-toolbar"> -->
                  <div class="row">
                    <div class="col-md-3">
            ...
            <div class="row">
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <h4 class="card-title">List of Official Results for  Full Scholars and Recipients</h4>
                    <table class="table">
                      <thead>
                        <tr>
                          <th style="width:5%;">#</th>
                      ...
                      <?php
                        if($_SESSION['page']<=1){
                          echo '<button class="btn btn-warning" disabled>Previous</button>';
                           ...
                           echo '<a href="reportscurrentofficial_back.php" class="btn btn-warning" >Previous</a>';
                        }
                      ?>
                       <?php echo ($off+1)."-".$count.'/'.$total?>
                        ...
                        if($count>=$total){
                          echo '<button class="btn btn-primary" disabled>Next</button>';
                           ...
                           echo '<a href="reportscurrentofficial_next.php" class="btn btn-primary">Next</a>';
                        }
                      ?>
...
<div class="modal fade" id="modalDetailed" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Official Report</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
