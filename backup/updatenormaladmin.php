      ...
      if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
              echo "<tr>";
                ...
                echo "<td><input type='year_level' value='".$row['year_level']."' name='year_level' class='form-control input-lg' placeholder='".$row['year_level']."'></td>";
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="updatenormaladmin.php">Back</a>
          </div>
        </div>
      </div>
    </div>
