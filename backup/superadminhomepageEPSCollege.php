...
<div class="row">
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-dark o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="superadminhomepage.php">
        ...
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="superadminhomepageEASHS.php">
         ...
         <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="superadminhomepageEACollege.php">
        ...
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="superadminhomepageEPSCollege.php">
...
WHERE canview = '0'&&approve = '1' and Category = 'EPS College' && d.id = (SELECT MAX(g2.id) FROM tbl_grades g2 WHERE d.user_id = g2.user_id )";
      ...
      if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
              ...
              echo "<tr>";
                ...
                echo "<td><a href='update.php?id=".$row['id']."'>Insert</a></td>";
                echo "<td><a href='editgrades.php?id=".$row['id']."'>Edit Grades</a></td>";
