      ...
      <div class="row">
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-dark o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="manageapplicant.php">
        ...
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="manageapplicantEASHS.php">
         ...
         <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="manageapplicantEACollege.php">
        ...
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="manageapplicantEPSCollege.php">
...
WHERE canview = '1' and approve = '1' and Category = 'EA Senior High'";
      ...
      if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
              echo "<tr>";
                ...
                echo "<td><a href='retrieve.php?id=".$row['id']."'>Retrieve</a></td>";
        ...
        <div class="modal-content">
         ...
         1. View statistics of approved applicant's by clicking the link at the left side "Dashboard"<br><br>
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="manageapplicant.php">Back</a>
          </div>
        </div>
      </div>
    </div>
