...
WHERE canview = '0' and approve = '0'&& d.id = (SELECT MAX(g2.id) FROM tbl_grades g2 WHERE d.user_id = g2.user_id )";
          ...
          while ($row = $result->fetch_assoc()) {
              echo "<tr>";
                ...
                // echo "<td><a href='remove.php?id=".$row['id']."'> Remove </a></td>";
                 echo "<td><a href='#' data-toggle='modal' data-target='#removeStudent'> Remove </a></td>";
