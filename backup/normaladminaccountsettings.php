      ...
      <ul class="navbar-nav ml-auto">
        ...
        <?php
         ...
         if($oldpassword == $oldpwDB)
         {
          ...
          {
            $sql2 = "UPDATE tbl_admin SET password = '$newpassword' WHERE username='$username'";
            ...
            if (mysqli_query($conn, $sql2)){
             ...
             echo "<script> 
              ...
              echo "<script> 
                   window.location.href='normaladminaccountsettings.php';
                   </script>";
...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-12" style="padding-top:25px;">
            ...
            <form action="adminchangeprofile.php" method="post" enctype="multipart/form-data">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="normaladminaccountsettings.php">Back</a>
          </div>
        </div>
      </div>
    </div>
